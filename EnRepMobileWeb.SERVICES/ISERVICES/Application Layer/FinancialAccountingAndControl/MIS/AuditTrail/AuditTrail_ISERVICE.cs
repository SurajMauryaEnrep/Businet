...
namespace EnRepMobileWeb.SERVICES.ISERVICES.Application_Layer.FinancialAccountingAndControl.MIS.AuditTrail
{
   public interface AuditTrail_ISERVICE
    {
        ...
        DataTable GetAuditTrailDetailsMIS(string CompID, string BrID, string FromDate, string ToDate, string GroupId, string AccountID, string AmtFrom,
