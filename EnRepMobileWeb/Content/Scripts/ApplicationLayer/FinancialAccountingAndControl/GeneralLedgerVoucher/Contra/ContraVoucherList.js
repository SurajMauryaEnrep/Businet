...
$(document).ready(function () {
    ...
    //    $("#hdDoc_No").val(VouNo);
    //    GetWorkFlowDetails(VouNo, Voudt, Doc_id);
    //});
    var Doc_id = $("#DocumentMenuId").val();
    $("#ContraList #datatable-buttons tbody").bind("dblclick", function (e) {
            ...
            try {
                ...
                if (VouNo != null && VouNo != "") {
                    window.location.href = "/ApplicationLayer/Contra/EditVou/?VouNo=" + VouNo + "&Voudt=" + Voudt + "&ListFilterData=" + ListFilterData + "&WF_Status=" + WF_Status;
                }
    ...
    //    $("#datatable-buttons_wrapper .dt-buttons").append('<button class="btn btn-default buttons-csv buttons-html5 btn-sm Csv" id="" onclick="ContraVoucherCSV()"  tabindex="0" aria-controls="datatable-buttons5" href="#"><span>CSV</span></button>')
    //});
});
function ContraVoucherCSV() {
    var Fromdate = $("#txtFromdate").val();
    var Todate = $("#txtTodate").val();
    var Status = $("#ddlStatus").val().trim();
    window.location.href = "/ApplicationLayer/Contra/ContraExporttoExcelDt?Fromdate=" + Fromdate + "&Todate=" + Todate + "&Status=" + Status;
}
function BtnSearch() {
    debugger;
    FilterContraList();
...
function FilterContraList() {
    ...
    try {
        ...
        $.ajax({
            type: "POST",
            url: "/ApplicationLayer/Contra/SearchContraVoucherDetail",
            data: {
...
function OnClickIconBtn(e) {
    ...
    var vou_no = clickedrow.find("#Cv_Vouno").text();
    var voudt = clickedrow.find("#Cv_Date").text();
