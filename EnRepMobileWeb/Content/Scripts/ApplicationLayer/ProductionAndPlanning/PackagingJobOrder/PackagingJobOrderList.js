$(document).ready(function () {
    ...
    $("#datatable-buttons >tbody").bind("dblclick", function (e) {
        ...
        if (RJO_No != "" && RJO_No != null) {
            location.href = "/ApplicationLayer/PackagingJobOrder/PJODoubleClickFromList/?DocNo=" + RJO_No + "&DocDate=" + RJO_Date + "&ListFilterData=" + ListFilterData + "&WF_Status=" + WF_Status + "&ItemIdList=" + ItemIdList;
    ...
    DynamicSerchableItemDDL("", "#ddl_ItemNameList", "", "", "", "PkgJobOrdr", "Y");/* Added by Suraj Maurya on 28-07-2025 */
...
function FilterRJOList() {
    ...
    try {
        ...
        $.ajax({
            type: "POST",
            url: "/ApplicationLayer/PackagingJobOrder/SearchPackingJOListDetail",
            data: {
                ItemId: ItemId,
                Fromdate: Fromdate,
                Todate: Todate,
