...
/************************************************
Javascript Name:Service Verification List
Created By:Mukesh
...
$(document).ready(function () {
    ...
    $("#datatable-buttons >tbody").bind("dblclick", function (e) {
        ...
        var VerNo = clickedrow.children("#VerNo").text();
        var VerDt = clickedrow.children("#VerDt").text();
        if (VerNo != "" && VerNo != null) {
            location.href = "/ApplicationLayer/ServiceVerification/DoubleClickOnList/?DocNo=" + VerNo + "&DocDate=" + VerDt + "&ListFilterData=" + ListFilterData + "&WF_status=" + WF_status;
        }
    ...
    $("#datatable-buttons >tbody").bind("click", function (e) {
        ...
        GetWorkFlowDetails(VerNo, VerDt, Doc_id, Doc_Status);
...
function FilterVerificationList() {
    ...
    try {
        ...
        $.ajax({
            type: "POST",
            url: "/ApplicationLayer/ServiceVerification/SearchVerificationList",
            data: {
                SuppId: SuppId,
                Fromdate: Fromdate,
                Todate: Todate,
            ...
            success: function (data) {
                debugger;
                $('#tbodyVerificationList').html(data);
