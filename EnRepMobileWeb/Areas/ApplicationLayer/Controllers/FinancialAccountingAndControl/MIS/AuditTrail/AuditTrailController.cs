...
using EnRepMobileWeb.MODELS.ApplicationLayer.FinancialAccountingAndControl.MIS.AuditTrail;
...
namespace EnRepMobileWeb.Areas.ApplicationLayer.Controllers.FinancialAccountingAndControl.MIS.AuditTrail
{
    public class AuditTrailController : Controller
    {
        string CompID, BrID, UserID, title, language = String.Empty;
        string DocumentMenuId = "105104135175";
        Logging.ErrorLog Errorlog = new Logging.ErrorLog();
        Common_IServices _Common_IServices;
        AuditTrail_ISERVICE _AuditTrail_ISERVICE;
        List<AuditTrailList> _AuditTrailList;
        public AuditTrailController(Common_IServices _Common_IServices, AuditTrail_ISERVICE _AuditTrail_ISERVICE)
        {
            this._Common_IServices = _Common_IServices;
            this._AuditTrail_ISERVICE = _AuditTrail_ISERVICE;
        }
        // GET: ApplicationLayer/AuditTrail
        public ActionResult AuditTrail()
        {
            CommonPageDetails();
            AuditTrailModel _AuditTrailModel = new AuditTrailModel();

            DataSet dttbl = new DataSet();
            dttbl = GetFyList();
            if (dttbl.Tables[0].Rows.Count > 0 && dttbl.Tables[1].Rows.Count > 0)
            {
                _AuditTrailModel.FromVouDate = dttbl.Tables[0].Rows[0]["currfy_startdt"].ToString();
            ...
            _AuditTrailModel.StatusList = statusLists;
            ...
            _AuditTrailModel.CreatorList = crtList;
            ...
            _AuditTrailModel.ApproverList = appList;
            //ViewBag.MenuPageName = getDocumentName();
            _AuditTrailModel.Title = title;
            return View("~/Areas/ApplicationLayer/Views/FinancialAccountingAndControl/MIS/AuditTrail/AuditTrail.cshtml", _AuditTrailModel);
        }
        private DataSet GetFyList()
        {
            try
            {
                ...
                DataSet dt = _AuditTrail_ISERVICE.Get_FYList(Comp_ID, BrID);
                return dt;
            }
            catch (Exception ex)
            {
        ...
        public ActionResult GetAutoCompleteAccGrp(AuditTrailModel _AuditTrailModel)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(_AuditTrailModel.ddlGroup))
                {
                    GroupName = "0";
                }
                else
                {
                    GroupName = _AuditTrailModel.ddlGroup;
                }
                suggestions = _AuditTrail_ISERVICE.AccGrpListGroupDAL(GroupName, Comp_ID);
            }
            catch (Exception Ex)
            {
                string path = Server.MapPath("~");
        ...
        public ActionResult GetAutoCompleteGLList(AuditTrailModel _AuditTrailModel, string GLGroupId/*, string type*/)
        {
            ...
            try
            {
                ...
                //if(type== "Onchange")
                //{
                GLList = _AuditTrail_ISERVICE.GetGLAccountList(Comp_ID, Br_ID, GLGroupId, GroupName);
                //}
                //else
                //{
        ...
        public ActionResult SearchAuditTrailDetails(string FromDate, string ToDate, string GroupId, string AccountID, string AmtFrom,
            string AmtTo, string VouTyp, string CreatBy, string CreatOn, string AppBy, string AppOn, string Narr, string Status)
        {

            try
            {
                AuditTrailModel objModel = new AuditTrailModel();
                objModel.SearchStatus = "ATSEARCH";

                ViewBag.AuditTrailDetails = GetAuditTrailListDetails(FromDate, ToDate, GroupId, AccountID, AmtFrom, AmtTo,
                VouTyp, CreatBy, CreatOn, AppBy, AppOn, Narr, Status);
                return PartialView("~/Areas/ApplicationLayer/Views/Shared/PartialMISAuditTrailList.cshtml", objModel);
            }
            catch (Exception ex)
            {
                string path = Server.MapPath("~");
        ...
        public DataTable GetAuditTrailListDetails(string FromDate, string ToDate, string GroupId, string AccountID, string AmtFrom,
            string AmtTo, string VouTyp, string CreatBy, string CreatOn, string AppBy, string AppOn, string Narr, string Status)
        {
            try
            {
                ...
                if (Session["BranchId"] != null)
                    BrID = Session["BranchId"].ToString();
                DataTable dt = _AuditTrail_ISERVICE.GetAuditTrailDetailsMIS(CompID, BrID, FromDate, ToDate, GroupId, AccountID, AmtFrom, AmtTo,
                VouTyp, CreatBy, CreatOn, AppBy, AppOn, Narr, Status);
                if (dt.Rows.Count > 0)
                {
                    return dt;
        ...
        private List<AuditTrailList> getAuditTrailList(string filters)
        {
            List<AuditTrailList> _AuditTrailListDetail = new List<AuditTrailList>();
            try
            {
                ...
                if (filters != null)
                {
                    if (filters != "")
                    {
                        ...
                        dt = _AuditTrail_ISERVICE.GetAuditTrailDetailsMIS(CompID, BrID, FromDate, ToDate, GroupId, AccountID, AmtFrom, AmtTo,
               VouTyp, CreatBy, CreatOn, AppBy, AppOn, Narr, Status);
                    }
                }
                if (dt.Rows.Count > 0)
                {
                    ...
                    {
                        AuditTrailList _AuditTrailList = new AuditTrailList();
                        _AuditTrailList.SrNo = rowno + 1;
                        //_AuditTrailList.sono_total = dr["sno3"].ToString();
                        _AuditTrailList.Vou_contain_row = dr["Sno_vou_no"].ToString();
                        _AuditTrailList.Vou_No = dr["vou_no"].ToString();
                        _AuditTrailList.Vou_Dt = dr["vou_date"].ToString();
                        _AuditTrailList.Vou_Type = dr["vou_type"].ToString();
                        _AuditTrailList.Vou_TypeName = dr["VouTypeName"].ToString();
                        _AuditTrailList.Instrument_Type = dr["InstrumentTyp"].ToString();
                        _AuditTrailList.Instrument_TypeName = dr["InstrumentTypName"].ToString();
                        _AuditTrailList.Instrument_No = dr["InstrumentNo"].ToString();
                        _AuditTrailList.StatusId = dr["vou_status"].ToString();
                        _AuditTrailList.StatusName = dr["VouStatusName"].ToString();

                        _AuditTrailList.Created_By = dr["Created_By"].ToString();
                        _AuditTrailList.Created_On = dr["Created_On"].ToString();
                        _AuditTrailList.Approved_By = dr["Approved_By"].ToString();
                        _AuditTrailList.Approved_On = dr["Approved_On"].ToString();
                        _AuditTrailList.Cancelled_By = dr["Cancelled_By"].ToString();
                        _AuditTrailList.Cancelled_On = dr["Cancelled_On"].ToString();
                        _AuditTrailList.Cancelled_Remarks = dr["Cancelled_remarks"].ToString();

                        _AuditTrailList.CurrId = dr["curr_id"].ToString();
                        _AuditTrailList.CurrName = dr["curr_name"].ToString();
                        _AuditTrailList.Acc_Id = dr["acc_id"].ToString();
                        _AuditTrailList.Acc_Name = dr["acc_name"].ToString();
                        _AuditTrailList.Dr_Amt = dr["dr_amt_bs"].ToString();
                        _AuditTrailList.Cr_Amt = dr["cr_amt_bs"].ToString();
                        _AuditTrailList.Narr = dr["narr"].ToString();
                        _AuditTrailListDetail.Add(_AuditTrailList);
                        rowno = rowno + 1;
                    }
                }
            }
            ...
            return _AuditTrailListDetail;
        }
        public ActionResult AuditTrailPrintCsv(AuditTrailModel _AuditTrailModel, string command)
        {
            try
            {
                if (_AuditTrailModel.hdnPDFPrint == "Print")
                {
                    command = "Print";
                }
                if (_AuditTrailModel.hdnCSVPrint == "CsvPrint")
                {
                    command = "CsvPrint";
                }
                switch (command)
                {
                    case "Print":
                        _AuditTrailModel.hdnPDFPrint = null;
                        return GenratePdfFile(_AuditTrailModel);
                    case "CsvPrint":
                        _AuditTrailModel.hdnCSVPrint = null;
                        return ExportAuditTrailData(_AuditTrailModel);
                    //return ExportTrialBalanceData(_AuditTrailModel);
        ...
        public FileResult ExportAuditTrailData(AuditTrailModel _AuditTrailModel)
        {
            try
            {
                ...
                List<AuditTrailList> _JournalBookListDetail = new List<AuditTrailList>();

                _JournalBookListDetail = getAuditTrailList(_AuditTrailModel.Allfilters);
                var ItemListData = (from tempitem in _JournalBookListDetail select tempitem);

                string searchValue = _AuditTrailModel.searchValue;
                ...
                string Fstring = string.Empty;
                string[] fdata;
                Fstring = _AuditTrailModel.Allfilters;
                fdata = Fstring.Split(',');
                DataTable dt = new DataTable();

                dt = ToAuditTrailDetailExl(data);
        ...
        public DataTable ToAuditTrailDetailExl(List<AuditTrailList> _ItemListModel)
        {
            ...
            dataTable.Columns.Add("Cancelled By", typeof(string));
            dataTable.Columns.Add("Cancelled On", typeof(string));
            dataTable.Columns.Add("Cancellation Remarks", typeof(string));
            ...
            foreach (var item in _ItemListModel)
            {
                ...
                rows["Created By"] = item.Created_By;
                rows["Created On"] = item.Created_On;
                rows["Approved By"] = item.Approved_By;
                rows["Approved On"] = item.Approved_On;
                rows["Cancelled By"] = item.Cancelled_By;
                rows["Cancelled On"] = item.Cancelled_On;
                rows["Cancellation Remarks"] = item.Cancelled_Remarks;
        ...
        //[HttpPost]
        public FileResult GenratePdfFile(AuditTrailModel _AuditTrailModel)
        {
            ...
            try
            {
                ...
                _AuditTrailModel.hdnPDFPrint = null;
                JArray jObject = JArray.Parse(_AuditTrailModel.PrintData);
                ...
                DataTable Details = _AuditTrail_ISERVICE.GetAuditTrailDetailsMIS(CompID, BrID, FromDate, ToDate, GroupId, AccountID, AmtFrom, AmtTo,
                VouTyp, CreatBy, CreatOn, AppBy, AppOn, Narr, Status);

                if (_AuditTrailModel.ddlGroup == "0")
                {
                    _AuditTrailModel.ddlGroupName = "All";
                }
                if (_AuditTrailModel.GLAccount == "0")
                {
                    _AuditTrailModel.GLAccountName = "All";
                }
                if (_AuditTrailModel.VouType == "0")
                {
                    _AuditTrailModel.VouTypeName = "All";
                }
                if (_AuditTrailModel.CreatedBy == "0")
                {
                    _AuditTrailModel.CreatorName = "All";
                }
                if (_AuditTrailModel.ApprovedBy == "0")
                {
                    _AuditTrailModel.ApproverName = "All";
                }
                if (_AuditTrailModel.Status == "0")
                {
                    _AuditTrailModel.StatusName = "All";
                }
                ...
                //ViewBag.FromDate = Convert.ToDateTime(_AuditTrailModel.FromVouDate).ToString("dd-MM-yyyy");
                //ViewBag.ToDate = Convert.ToDateTime(_AuditTrailModel.ToVouDate).ToString("dd-MM-yyyy");
                ...
                using (MemoryStream stream = new System.IO.MemoryStream())
                {
                    ...
                    htmlcontent = ConvertPartialViewToString(PartialView("~/Areas/ApplicationLayer/Views/FinancialAccountingAndControl/MIS/AuditTrail/AuditTrailPrint.cshtml", _AuditTrailModel));
                    ...
                    return File(bytes.ToArray(), "application/pdf", "AuditTrail.pdf");
                }
            }
            catch (Exception ex)
            {
        ...
        private void CommonPageDetails()
        {
            try
            {
                ...
                DataSet ds = _AuditTrail_ISERVICE.GetAllDDLDetails(CompID, BrID, UserID, DocumentMenuId, language);
