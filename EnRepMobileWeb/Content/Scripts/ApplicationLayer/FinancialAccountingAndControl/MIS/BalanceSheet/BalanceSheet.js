...
$(document).ready(function () {
    ...
    //$("#btn_GeneratePDF").attr("disabled", true);
    //$("#btn_GeneratePDF").prop("disabled", true);
    BindBr_list();
});
...
function GetBlanceSheet_Details() {
    debugger;
    showLoader();
    ...
    if (Flag == "Y") {
        ...
        try {
            $.ajax({
                type: "POST",
                url: "/ApplicationLayer/BalanceSheet/SearchBalanceSheetDetail",
                data: {
                ...
                success: function (data) {
                    ...
                    $('#div_balsheet').html(data);
                    debugger;
                    //$("#btn_GeneratePDF").attr("disabled", false);
                    //$("#btn_GeneratePDF").prop("disabled", false);
                    $("#div_GeneratePDF").css("display", "");
...
function BindBr_list() {

    var rptflag = "C";
    //if ($("#rstndlone").is(":checked")) {
    //    debugger
    //    rptflag = "S";
    //}
    //if ($("#rconsoli").is(":checked")) {
    //    debugger
    //    rptflag = "C";
    //}
    ...
    try {
        $.ajax({
            type: "POST",
            url: "/Common/Common/Cmn_GetBrList",
            data: { flag: rptflag },
            success: function (data) {
                debugger;

                $('#div_ddl_brlist').html(data);
        ...
        console.log("Balance Sheet Error : " + err.message);
    }
}
...
function GenerateBalanceSheetPDF() {
    ...
    if (Flag == "Y") {
        ...
        window.location.href = "/ApplicationLayer/BalanceSheet/GenrateBLSheetPdfFile1?RptType=" + rpttype + "&from_dt=" + from_dt + "&to_dt=" + to_dt + "&br_list=" + brid_list
    }
}
