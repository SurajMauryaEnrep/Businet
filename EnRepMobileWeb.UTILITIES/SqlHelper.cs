...
namespace EnRepMobileWeb.UTILITIES
{
    ...
    public sealed class SqlHelper
    {
        ...
        static SqlHelper()
        {
            ...
            //connectionString = root.GetConnectionString("EnRepConn");
            connectionString = ConfigurationManager.ConnectionStrings["EnRep"].ConnectionString; 

            //connectionString = app ConnectionStrings["FiddleFitDBConnection"].ConnectionString;
        }
        /// <summary>
        ...
        public static int ExecuteNonQuery(string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                SqlParameter[] commandParameters = SqlHelperParameterCache.GetSpParameterSet(spName, true);
                ...
                intReturn = ExecuteNonQuery(CommandType.StoredProcedure, spName, commandParameters);
        ...
        public static DataSet ExecuteDataset(string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                SqlParameter[] commandParameters = SqlHelperParameterCache.GetSpParameterSet(spName, true); // Added Parameter true to support ReturnValues
                ...
                dsReturn = ExecuteDataset(CommandType.StoredProcedure, spName, commandParameters);
            ...
            else
            {
                ...
                //Modify code
                dsReturn = ExecuteDataset(CommandType.StoredProcedure, spName);
            }
            //Modify code
            return dsReturn;
        }
        ...
        public static SqlDataReader ExecuteReader(string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                drReturn = ExecuteReader(CommandType.StoredProcedure, spName, commandParameters);
            ...
            else
            {
                ...
                drReturn = ExecuteReader(CommandType.StoredProcedure, spName);
                return drReturn;
            }
    ...
    public sealed class SqlHelperParameterCache
    {
        ...
        {
            //connectionString = WebConfigurationManager.ConnectionStrings["CMSAppData"].ConnectionString;
            // connectionString = "Data Source=184.168.194.58;Initial Catalog=pashubajaar_stage;Uid=pashubajaar;PWD=Cantata321@@;";
