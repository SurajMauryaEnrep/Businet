...
(function () {
    ...
    b = window.Morris = {}, a = jQuery, b.EventEmitter = function () {
        ...
        return h(d, c), d.prototype.gridDefaults = {
            ...
            var a, b, c, d, e, f, g, h;
            return e = this.el.width(), c = this.el.height(), (this.elementWidth !== e || this.elementHeight !== c || this.dirty) && (this.elementWidth = e, this.elementHeight = c, this.dirty = !1, this.left = this.options.paddingLeft, this.right = this.elementWidth - this.options.paddingLeft/2, this.top = this.options.paddingTop, this.bottom = this.elementHeight - this.options.paddingBottom, ((g = this.options.axes) === !0 || "both" === g || "y" === g) && (f = function () {
                var a, c, d, e;
            ...
            if (this.options.grid !== !1 || (e = this.options.axes) === !0 || "both" === e || "y" === e) {
                for (f = this.grid, h = [], c = 0, d = f.length; d > c; c++) a = f[c], b = this.transY(a), ((g = this.options.axes) === !0 || "both" === g || "y" === g) && this.drawYAxisLabel(this.left - this.options.paddingBottom / 2, b, this.yAxisFormat(a)), this.options.grid ? h.push(this.drawGridLine("M" +
                    + "," + b + "H" + (this.left + this.width))) : h.push(void 0);
                return h
            }
        ...
        return h(c, a), c.prototype.init = function () {
            ...
            for (h = this.bottom + this.options.paddingBottom / 2, f = null, e = null, a = function (a, b) {
                var c, d, g, i, j;
