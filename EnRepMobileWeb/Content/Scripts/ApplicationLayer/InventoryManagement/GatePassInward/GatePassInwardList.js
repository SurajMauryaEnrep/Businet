    ...
    $("#datatable-buttons tbody tr").bind("dblclick", function (e) {
        ...
        try {
            ...
            if (Gate_no != null && Gate_no != "" && Gate_dt != null && Gate_dt != "") {
                window.location.href = "/ApplicationLayer/GatePassInward/DblClick/?Gate_no=" + Gate_no + "&Gate_dt=" + Gate_dt + "&ListFilterData=" + ListFilterData + "&WF_Status=" + WF_Status;
            }
        }
        catch (err) {
            debugger
...
function SearchData() {
    debugger;
    try {
        var Source_type = $("#ddlSourceType").val();
        $("hd_SourceTypeID").val(Source_type);
        ...
        $.ajax({
            type: "POST",
            url: "/ApplicationLayer/GatePassInward/DataSearch_Search",
            data: {
            ...
            success: function (data) {
                debugger;
                $('#ListtblGatePassInWard').html(data);
                $('#ListFilterData').val(Entity_type + ',' + Entity_id + ',' + Fromdate + ',' + Todate + ',' + Status + ',' + Source_type);
            },
