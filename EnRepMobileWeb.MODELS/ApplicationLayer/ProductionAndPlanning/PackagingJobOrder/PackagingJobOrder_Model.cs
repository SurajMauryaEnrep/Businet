...
namespace EnRepMobileWeb.MODELS.ApplicationLayer.ProductionAndPlanning.PackagingJobOrder
{
   public class PackagingJobOrder_Model
    {
        ...
        public string PJO_No { get; set; }
        public string PJO_Date { get; set; }
        ...
        public string hdnMatrialtypeForCunsume { get; set; }
    ...
    public class PJOListModel
    {
        public string PJOSearch { get; set; }
       ...
       public string Item_Id { get; set; }
        ...
        public List<PJOList> packingJobOrdrList { get; set; }
    ...
    public class PJOList
    {
        public string FinStDt { get; set; }
        public string PJONumber { get; set; }
        public string PJODate { get; set; }
        public string PJO_Dt { get; set; }
        public string ItemName { get; set; }
        public string ItemID { get; set; }
        public string Uom { get; set; }
        public string PkgQty { get; set; }
        public string PJO_Status { get; set; }
