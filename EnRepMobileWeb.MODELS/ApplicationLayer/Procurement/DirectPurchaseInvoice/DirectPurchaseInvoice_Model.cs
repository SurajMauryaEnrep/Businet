...
namespace EnRepMobileWeb.MODELS.ApplicationLayer.Procurement.DirectPurchaseInvoice
{
    public class DirectPurchaseInvoice_Model
    {
        ...
        public string DPI_SuppID { get; set; }
        ...
        public string DPI_SuppName { get; set; }
    ...
    public class DPIListModel
    {
        public string Title { get; set; }
        public string SuppID { get; set; }
        public string FromDate { get; set; }
        public string ToDate { get; set; }
        public string DPI_ToDate { get; set; }
        public string DPI_FromDate { get; set; }
