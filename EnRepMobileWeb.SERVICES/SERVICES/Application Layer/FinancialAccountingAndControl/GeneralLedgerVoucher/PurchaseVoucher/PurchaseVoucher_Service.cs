...
namespace EnRepMobileWeb.SERVICES.SERVICES.Application_Layer.FinancialAccountingAndControl.GeneralLedgerVoucher.PurchaseVoucher
{
    public class PurchaseVoucher_Service : PurchaseVoucher_IService
    {
        public Dictionary<string, string> AutoGetSuppAccList(string CompID, string AccName, string BrchID)
        {
            ...
            try
            {
                ...
                DataSet PARQusData = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "stp$gl$detail_GetSuppListDetail", prmContentGetDetails);
                DataRow dr;
                ...
                if (PARQusData.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        ddlItemNameDictionary.Add(PARQusData.Tables[0].Rows[i]["supp_acc_id"].ToString(), PARQusData.Tables[0].Rows[i]["supp_acc_name"].ToString());
                    }
                }
        ...
        public String InsertPurchaseVoucherDetail(DataTable PurchaseVoucherHeader, DataTable PurchaseVoucherGLDetails, DataTable PVAttachments,DataTable CRCostCenterDetails)
        {
            ...
            try
            {
                ...
                SqlParameter[] prmcontentaddupdate = {
                 ...
                 objprovider.CreateInitializedParameterTableType("@HeaderDetail",SqlDbType.Structured, PurchaseVoucherHeader ),
                 objprovider.CreateInitializedParameterTableType("@AccountDetail",SqlDbType.Structured, PurchaseVoucherGLDetails ),
                 objprovider.CreateInitializedParameterTableType("@AttachmentDetail",SqlDbType.Structured, PVAttachments ),
                ...
                string PV_no = SqlHelper.ExecuteNonQuery(CommandType.StoredProcedure, "Cmn_fin$gl$vou$InsertUpdate", prmcontentaddupdate).ToString();
        ...
        public DataSet GetSuppAccIDDetail(string CompID, string BrchID, string SuppAccID, string VouDate)
        {
            SqlDataProvider objProvider = new SqlDataProvider();
            SqlParameter[] prmContentGetDetails = {/*Passing perameter to sotore procedure*/   
                    objProvider.CreateInitializedParameter("@CompID",DbType.String, CompID),
                     objProvider.CreateInitializedParameter("@BrID",DbType.String, BrchID),
                     objProvider.CreateInitializedParameter("@SuppAccID",DbType.String, SuppAccID),
                     objProvider.CreateInitializedParameter("@VouDate",DbType.String, VouDate),
                                                     };
            DataSet ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "[sp_GetSuppAccDetail]", prmContentGetDetails);
            return ds;
        }
        public DataSet GetPurchaseVoucherListAll( int curr,string SuppId, string Fromdate, string Todate, string Status, string CompID, string BrchID, string VouType, string wfstatus, string UserID, string DocumentMenuId)
        {
            SqlDataProvider objProvider = new SqlDataProvider();
            SqlParameter[] prmContentGetDetails = {/*Passing perameter to sotore procedure*/   
            ...
            DataSet dt = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "sp_GetPurchaseVoucherList", prmContentGetDetails);
            return dt;
        }

        public DataSet GetPurchaseVoucherDetail(string VouNo, string Voudt,string VouType, string CompID, string BrchID, string UserID, string DocumentMenuId)
        {
            try
            {
                SqlDataProvider objProvider = new SqlDataProvider();
                ...
                DataSet ds = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "[sp_PurchaseVoucher$DetailView]", prmContentGetDetails);
                return ds;
            }
            catch (SqlException ex)
            {
        ...
        public string PVDelete(PurchaseVoucher_Model _PurchaseVoucher_Model, string CompID, string br_id, string DocumentMenuId)
        {
            try
            {
                SqlDataProvider objProvider = new SqlDataProvider();
                SqlParameter[] prmContentGetDetails = {/*Passing perameter to sotore procedure*/   
                    ...
                    objProvider.CreateInitializedParameter("@br_id",DbType.String, br_id),
                    objProvider.CreateInitializedParameter("@vou_no",DbType.String, _PurchaseVoucher_Model.Vou_No),
                    objProvider.CreateInitializedParameter("@vou_dt",DbType.Date,  _PurchaseVoucher_Model.Vou_Date),
        ...
        public string PurchaseVoucherApprove(string VouNo, string VouDate, string userid, string wf_status, string wf_level, string wf_remarks, string comp_id, string br_id, string mac_id, string DocID)
        {
            try
            {
                SqlDataProvider objProvider = new SqlDataProvider();
                ...
                DataSet VouDeatils = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "sp_fin$gl$pur$vou$Approve", prmContentGetDetails);
        ...
        public DataSet PurchaseVoucherCancel(PurchaseVoucher_Model _PurchaseVoucher_Model, string CompID, string br_id, string mac_id)
        {
            SqlDataProvider objProvider = new SqlDataProvider();
            SqlParameter[] prmContentGetDetails = {/*Passing perameter to sotore procedure*/ 
                 objProvider.CreateInitializedParameter("@comp_id",DbType.Int16, CompID),
                    ...
                    objProvider.CreateInitializedParameter("@vou_no",DbType.String,  _PurchaseVoucher_Model.Vou_No),
                    objProvider.CreateInitializedParameter("@vou_dt",DbType.Date,  _PurchaseVoucher_Model.Vou_Date),
                    objProvider.CreateInitializedParameter("@CreateBy",DbType.String, _PurchaseVoucher_Model.Create_by ),
                     objProvider.CreateInitializedParameter("@mac_id",DbType.String, mac_id),
                     objProvider.CreateInitializedParameter("@CancelledRemarks",DbType.String, _PurchaseVoucher_Model.CancelledRemarks),
               };

            DataSet DS = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "sp_fin$PurchaseVoucherCancel", prmContentGetDetails);

            return DS;
        }
        public DataSet GetBillDetail(string CompID, string BrchID, string AccId,string fromdt,string todt,string flag, string DocumentNumber, string Status)
        {
            SqlDataProvider objProvider = new SqlDataProvider();
            SqlParameter[] prmContentGetDetails = {/*Passing perameter to sotore procedure*/   
                    objProvider.CreateInitializedParameter("@CompID",DbType.String, CompID),
        ...
        public DataSet CheckPVDetail(string CompId, string BrchID, string DocNo, string DocDate)
        {
            try
            {
                SqlDataProvider objProvider = new SqlDataProvider();
                ...
                DataSet GetDt = SqlHelper.ExecuteDataset(CommandType.StoredProcedure, "sp_CheckPaymentAgainstPV", prmContentGetDetails);
                return GetDt;
            }
            catch (SqlException ex)
            {
