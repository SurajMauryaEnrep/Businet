...
namespace EnRepMobileWeb.MODELS.ApplicationLayer.FinancialAccountingAndControl.MIS.JournalBook
{
   public class JournalBookModel
    {
        ...
        public List<JournalBookList> JournalBook_List { get; set; }
