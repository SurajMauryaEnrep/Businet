...
function init_morris_charts() {
    ...
    //    labels: ["Geekbench"],
    //    barRatio: .4,
    //    barColors: ["#57abff", "#34495E", "#ACADAC", "#3498DB"],
    //    xLabelAngle: 35,
    //    hideHover: "auto",
    //    resize: !0
...
$('.Calendar_Date_Time').datetimepicker({
    format: 'dd-mm-yyyy hh:ii',
    fontAwesome: true,
    wheelViewModeNavigation: true
})
/*$('.Calendar_Date_Time').datetimepicker('update', new Date())   */