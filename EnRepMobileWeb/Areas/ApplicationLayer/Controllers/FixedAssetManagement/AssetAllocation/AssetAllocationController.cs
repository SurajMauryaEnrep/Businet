...
namespace EnRepMobileWeb.Areas.ApplicationLayer.Controllers.FixedAssetManagement.AssetAllocation
{
    public class AssetAllocationController : Controller
    {
        ...
        public AssetAllocationController(Common_IServices _Common_IServices)
        {
            this._Common_IServices = _Common_IServices;
        }
        // GET: ApplicationLayer/AssetAllocation
        ...
        public ActionResult AddAssetAllocationDetail()
        {
            Session["Message"] = "New";
            Session["Command"] = "Add";
            Session["AppStatus"] = 'D';
            ...
            ViewBag.MenuPageName = getDocumentName();
            return RedirectToAction("AssetAllocationDetail", "AssetAllocation");
        }
        public ActionResult AssetAllocationDetail()
        {
            try
            {
                ViewBag.MenuPageName = getDocumentName();
