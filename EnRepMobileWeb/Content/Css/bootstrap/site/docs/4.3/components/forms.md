...
<form>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control remarksmessage" id="exampleFormControlTextarea1" rows="3"></textarea>
  </div>
</form>
{% endcapture %}
{% include example.html content=example %}
...
<form class="was-validated">
  <div class="mb-3">
    ...
    <textarea class="form-control remarksmessage is-invalid" id="validationTextarea" placeholder="Required example textarea" required></textarea>
    <div class="invalid-feedback">
