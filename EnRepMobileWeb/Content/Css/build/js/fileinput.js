 ...
 * 
 */
var DocMenuId = document.getElementById("DocumentMenuId");
if (DocMenuId != null) {
    DocMenuId = DocMenuId.value;
} else {
    DocMenuId = "";
}
var TotalFileCount = 5;
if (("105101145,105101152,105101154,105101150,105101147,105101140125,105103125").split(',').includes(DocMenuId)) {/* Added by Suraj Maurya on 27-05-2025 to increase file limit */
    TotalFileCount = 20;
}
(function (factory) {
    "use strict";
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFooter = '<div class="file-thumbnail-footer">\n' +
                ...
                '        <div class="file-caption-info" id="fname">{caption}</div>\n' +
            ...
            tImage = '<img src="{data}" class="file-preview-image kv-preview-data" title="{caption}" ' +
                'alt="{caption}" {style}>\n';
            tText = '<textarea class="kv-preview-data file-preview-text" title="{caption}" readonly style="width: 165px;height: 110px;">' +
                '{data}</textarea>\n';
            tOffice = '<iframe class="kv-preview-data file-preview-office" ' +
                'src="https://docs.google.com/gview?url={data}&embedded=true" style="width: 165px;height: 110px;"></iframe>';
            ...
            tPdf = '<embed class="kv-preview-data file-preview-pdf" src="{data}" type="application/pdf" style="width: 166px;height: 115px;">\n';
            ...
            self.defaults = {
                ...
                allowedPreviewTypes: ['image', 'html','office', 'text', 'video', 'audio', 'flash', 'pdf', 'object'],
                previewTemplates: {},
                previewSettings: {
        ...
        _ajaxSubmit: function (fnBefore, fnSuccess, fnComplete, fnError, previewId, index) {
            ...
            settings = $.extend(true, {}, {
                ...
                url: "/BusinessLayer/ItemDetail/Upload",//index && self.uploadUrlThumb ? self.uploadUrlThumb : self.uploadUrl,
                type: 'POST',
                dataType: 'json',
                data: self.formdata,
                cache: false,
        ...
        _filterDuplicate: function (file, files, fileIds) {
            ...
            if (!CheckSavedDuplicateImage(file)) {/*this function is on Common*/
                return;
            }
            if (!fileIds) {
                fileIds = [];
        ...
        _change: function (e) {
            ...
            if (DocMenuId == '103105') { setTimeout('Cmn_OnchangeFileInput()', 700) };
            ...
            self.maxFileCount = TotalFileCount - $("#hdn_attatchment_list> tbody > tr").length;
            if (self.maxFileCount > 0 && total > self.maxFileCount) {
                if (!self.autoReplace || len > self.maxFileCount) {
                    ...
                    self.$container.removeClass('file-input-new file-input-ajax-new');
                    self.$container.find('.fileinput-upload').css("display", "none");
                    self.$container.find('.fileinput-remove').css("display", "none");
                    return;
                }
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            ...
            next: '<i class="fa fa-caret-right fa-lg " aria-hidden="true"></i>',
        ...
        allowedFileExtensions: ['jpg', 'png', 'gif', 'pdf', 'mp4', 'xlsx','csv','txt','docx'],
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgDuplicateFileFound: 'Duplicate files found. {dfiles}',
