...
$(document).ready(function () {
    ...
    $("#datatable-buttons >tbody").bind("dblclick", function (e) {
        ...
        if (SSINo != "" && SSINo != null) {
            location.href = "/ApplicationLayer/ServiceSaleInvoice/DoubleClickOnList/?DocNo=" + SSINo + "&DocDate=" + SSIDt + "&ListFilterData=" + ListFilterData + "&WF_status=" + WF_status;
        }
...
function FilterVerificationList() {
    ...
    try {
        ...
        $.ajax({
            type: "POST",
            url: "/ApplicationLayer/ServiceSaleInvoice/SearchServiceSalesInvoiceList",
            data: {
                CustId: CustId,
                Fromdate: Fromdate,
                Todate: Todate,
