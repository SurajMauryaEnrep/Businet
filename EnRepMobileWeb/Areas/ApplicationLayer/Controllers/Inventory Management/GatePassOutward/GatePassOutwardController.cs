...
using EnRepMobileWeb.MODELS.ApplicationLayer.InventoryManagement.GatePassOutward;
...
namespace EnRepMobileWeb.Areas.ApplicationLayer.Controllers.Inventory_Management.GatePassOutward
{
    public class GatePassOutwardController : Controller
    {
        string CompID, BrchID, UserID, language, title = String.Empty;
        string DocumentMenuId = "105102105";
        Logging.ErrorLog Errorlog = new Logging.ErrorLog();
        Common_IServices _Common_IServices;
        //SampleReceipt_ISERVICE _SampleReceipt_ISERVICE;
        GatePassOutwardDetail_IServices _GatePassOutwardDetail_IServices;
        GatePassOutwardList_IServices _GatePassOutwardList_IServices;
        public GatePassOutwardController(Common_IServices _Common_IServices, GatePassOutwardDetail_IServices _GatePassOutwardDetail_IServices, GatePassOutwardList_IServices _GatePassOutwardList_IServices)
        {
            this._Common_IServices = _Common_IServices;
            this._GatePassOutwardDetail_IServices = _GatePassOutwardDetail_IServices;
            this._GatePassOutwardList_IServices = _GatePassOutwardList_IServices;
        }
        public ActionResult DashBordtoList(string docid, string status)
        {
            var WF_status = status;
            return RedirectToAction("GatePassOutward", new { WF_status });
        }
        public ActionResult GatePassOutward(string WF_status)
        {
            GatePassOutwardList_Model ListModel = new GatePassOutwardList_Model();
            CompDataWithID();
            ...
            GatePassOutwardList_Model Gpass_model = new GatePassOutwardList_Model();
            if (TempData["ListFilterData"] != null && TempData["ListFilterData"].ToString() != "")
            {
             ...
             //   var EntityName = a[5].Trim();
                ...
                GetSupp_CustList(Gpass_model);
                DataTable dt = _GatePassOutwardList_IServices.SearchDataFilter(Entity_type, Entity_name, Fromdate, Todate, Status, CompID, BrchID, DocumentMenuId);
              //  ListModel.GpassSearch = "Search";
            ...
            else
            {
              ...
              //  ListModel.GpassSearch = "Gpass_Search";
                
                ViewBag.GatePassReciptList = GpassList;
            }
         
            ListModel.Title = title;
            return View("~/Areas/ApplicationLayer/Views/InventoryManagement/GatePassOutward/GatePassOutwardList.cshtml", ListModel);
        }
        public void BindAllDropDownList(GatePassOutwardList_Model ListModel)
        {
        ...
        private DataTable GetGatePassDetails(GatePassOutwardList_Model _listModel)
        {
            CompDataWithID();
            string wfstatus = "";
            ...
            DataSet dt = _GatePassOutwardList_IServices.GetAllDropDownList(CompID, BrchID, UserID, wfstatus, DocumentMenuId, _listModel.FromDate, _listModel.ToDate);
            return dt.Tables[0];
        }
        ...
        public ActionResult AddGatePassOutwardDetail()
        {
            CompDataWithID();
            ...
            if (commCont.CheckFinancialYear(CompID, BrchID) == "Not Exist")
            {
                ...
                return RedirectToAction("GatePassOutward");
            }
            else
            {
                GatePassOutwardDetail_Model AddNew_Model = new GatePassOutwardDetail_Model();
                ...
                return RedirectToAction("GatePassOutwardDetail", "GatePassOutward", NewModel);
            }

        }
        public ActionResult GatePassOutwardDetail(UrlModel _urlModel)
        {
            try
            {             
                CompDataWithID();
                ...
                var DetailModel = TempData["ModelData"] as GatePassOutwardDetail_Model;
                if (DetailModel != null)
                {
                   
                    SetData(DetailModel);
                    return View("~/Areas/ApplicationLayer/Views/InventoryManagement/GatePassOutward/GatePassOutwardDetail.cshtml", DetailModel);
                }
                else
                {
                    GatePassOutwardDetail_Model _model = new GatePassOutwardDetail_Model();
                    SetUrlData(_urlModel, _model);
                    SetData(_model);
                    return View("~/Areas/ApplicationLayer/Views/InventoryManagement/GatePassOutward/GatePassOutwardDetail.cshtml", _model);
                }
        ...
        private void SetUrlData(UrlModel _urlModel, GatePassOutwardDetail_Model _Model)
        {
        ...
        public void SetData(GatePassOutwardDetail_Model DetailModel)
        {
        ...
        public void SetAllDataInView(GatePassOutwardDetail_Model _GatePassModel)
        {
            try
            {
                CompDataWithID();
                ...
                DataSet ds = _GatePassOutwardDetail_IServices.GetFGRDeatilData(CompID, BrchID, Gpass_no, Gpass_dt, UserID, DocumentMenuId);
                ...
                _GatePassModel.IssuedBy = ds.Tables[0].Rows[0]["issue_by"].ToString();
                _GatePassModel.Issuedto = ds.Tables[0].Rows[0]["issue_to"].ToString();
                ...
                if (ds.Tables[0].Rows[0]["return_able"].ToString().Trim() == "Y")
                {
                    _GatePassModel.ReturnableFlag = true;
                }
                else
                {
                    _GatePassModel.ReturnableFlag = false;
                }
        ...
        public ActionResult GetSupp_CustListDeatil(GatePassOutwardDetail_Model DetailModel)
        {
            try
            {
                CompDataWithID();
                ...
                DataSet SuppCustList = _GatePassOutwardList_IServices.getSuppCustList(CompID, BrchID, EntityName, EntityType);
                if (EntityType == "0")
                {
        ...
        public void GetSupp_CustList1(GatePassOutwardList_Model ListModel)
        {
            try
            {
                CompDataWithID();
        ...
        public ActionResult GetSupp_CustList(GatePassOutwardList_Model ListModel)
        {
            try
            {
                CompDataWithID();
        ...
        public ActionResult SaveGPassOutwardDeatilData(GatePassOutwardDetail_Model DetailSaveModel, string command)
        {
            try
            {
                CompDataWithID();
                ...
                {
                    case "AddNew":
                        GatePassOutwardDetail_Model AddNewModel = new GatePassOutwardDetail_Model();
                        ...
                        if (commCont.CheckFinancialYear(CompID, BrchID) == "Not Exist")
                        {
                            ...
                            else
                            {
                                ...
                                return RedirectToAction("GatePassOutwardDetail", NewModel);
                            }
                        }
                    ...
                    case "Save":
                        ...
                        return RedirectToAction("GatePassOutwardDetail", SaveModel);
                    case "Edit":
                        if (commCont.CheckFinancialYear(CompID, BrchID) == "Not Exist")
                        {
                            TempData["Message"] = "Financial Year not Exist";
                        ...
                        TempData["ListFilterData"] = DetailSaveModel.ListFilterData1;
                        return RedirectToAction("GatePassOutwardDetail", EditModel);
                    case "Delete":
                        Delete(DetailSaveModel, command);
                        GatePassOutwardDetail_Model DeleteModel = new GatePassOutwardDetail_Model();
                        ...
                        TempData["ListFilterData"] = DetailSaveModel.ListFilterData1;
                        return RedirectToAction("GatePassOutwardDetail", Delete_Model);
                    case "Refresh":
                        GatePassOutwardDetail_Model RefreshModel = new GatePassOutwardDetail_Model();
                        ...
                        return RedirectToAction("GatePassOutwardDetail", Refresh_Model);
                    case "Approve":
                        ...
                        Approve.bt = "BtnEdit";
                        TempData["ListFilterData"] = DetailSaveModel.ListFilterData1;
                        return RedirectToAction("GatePassOutwardDetail", Approve);
                    case "Forward":
                        TempData["ListFilterData"] = DetailSaveModel.ListFilterData1;
                        if (commCont.CheckFinancialYear(CompID, BrchID) == "Not Exist")
                        {
        ...
        public FileResult GenratePdfFile(GatePassOutwardDetail_Model _GatePassOutward)
        {
           
         
            return File(GetPdfData(_GatePassOutward.GatePassNumber, _GatePassOutward.GatePassDate, _GatePassOutward.Status_Code), "application/pdf", "GatePassOutWard.pdf");
        }
        public byte[] GetPdfData(string Doc_No, string Doc_dt, string StatusCode)
        {
            ...
            try
            {
                GatePassOutwardDetail_Model _GatePassOutWard_Model = new GatePassOutwardDetail_Model();
                CompDataWithID();
                DataSet Details = _GatePassOutwardDetail_IServices.GetDataForPrint(CompID, BrchID, Doc_No, Convert.ToDateTime(Doc_dt).ToString("yyyy-MM-dd"));
                ...
                ViewBag.DocumentMenuId = DocumentMenuId;
                string htmlcontent = ConvertPartialViewToString(PartialView("~/Areas/ApplicationLayer/Views/InventoryManagement/GatePassOutward/GatePassOutwardPrint.cshtml"));
        ...
        public ActionResult GatePass_SaveUpdate(GatePassOutwardDetail_Model _model)
        {
            string SaveMessage = "";
            CommonPageDetails();
            ...
            try
            {
                if (_model.CancelFlag == false /*&& _model.ReturnableFlag == false*/)
                {
                    ...
                    dtheader.Columns.Add("issue_by", typeof(string));
                    ...
                    dtrowHeader["issue_to"] = _model.Issuedto;
                    dtrowHeader["issue_by"] = _model.IssuedBy;
                    ...
                    SaveMessage = _GatePassOutwardDetail_IServices.InsertUpdateData(FGRHeader, ItemDetails, Attachments);
                ...
                {
                    //var FlagCancel_return = "";
                    //if(_model.CancelFlag==true)
                    //{
                    //    FlagCancel_return = "CancelFlag";
                    //}
                    //if (_model.ReturnableFlag == true)
                    //{
                    //    FlagCancel_return = "ReturnableFlag";
                    //}
                    ...
                    DataSet message = _GatePassOutwardDetail_IServices.CancelAndReturnData(CompID, br_id, _model.GatePassNumber, _model.GatePassDate, UserID, DocumentMenuId, mac_id);
        ...
        {/*start Add by Hina on 20-02-2024 to chk Financial year exist or not*/
            ...
            /*End to chk Financial year exist or not*/
            GatePassOutwardDetail_Model dblclick = new GatePassOutwardDetail_Model();
            ...
            return RedirectToAction("GatePassOutwardDetail", _url);
        }
        private ActionResult Delete(GatePassOutwardDetail_Model _model, string command)
        {
            try
            {
                CompDataWithID();
                string doc_no = _model.GatePassNumber;
                DataSet Message = _GatePassOutwardDetail_IServices.DeleteData(CompID, BrchID, _model.GatePassNumber, _model.GatePassDate);
                ...
                return RedirectToAction("GatePassOutwardDetail");
            }
            catch (Exception ex)
            {
                string path = Server.MapPath("~");
        ...
        public ActionResult ApproveData(GatePassOutwardDetail_Model _model, string ListFilterData1, string WF_Status1)
        {
            try
            {
                CompDataWithID();
                ...
                string Message = _GatePassOutwardDetail_IServices.Approve_FinishedGoodsReceipt(CompID, BrchID, DocumentMenuId, gpass_no, gpass_dt, UserID, mac_id, A_Status, A_Level, A_Remarks);
                ...
                return RedirectToAction("GatePassOutwardDetail", ApproveModel);
            }
            catch (Exception ex)
            {
                string path = Server.MapPath("~");
        ...
        {
            //Session["Message"] = "";
            GatePassOutwardDetail_Model ToRefreshByJS = new GatePassOutwardDetail_Model();
            ...
            TempData["ListFilterData"] = ListFilterData1;
            return RedirectToAction("GatePassOutwardDetail", Model);
        }
        [HttpPost]
        public ActionResult DataSearch_Search(string Entity_type, string Entity_id, string Fromdate, string Todate, string Status)
        {
            ...
            {
                CompDataWithID();
                GatePassOutwardList_Model SearchModel = new GatePassOutwardList_Model();
                SearchModel.WF_Status = null;
                DataTable dt = _GatePassOutwardList_IServices.SearchDataFilter(Entity_type, Entity_id, Fromdate, Todate, Status, CompID, BrchID, DocumentMenuId);
                SearchModel.GpassSearch = "Search";
                ViewBag.GatePassReciptList = dt;
                return PartialView("~/Areas/ApplicationLayer/Views/Shared/PartialGatePassOutward.cshtml", SearchModel);
            }
            catch (Exception ex)
            {
                string path = Server.MapPath("~");
        ...
        public JsonResult GetCustandSuppAddrDetail(string Entity_Name, string Entity_Type)
        {
            try
            {
                ...
                CompDataWithID();
                DataSet result = _GatePassOutwardDetail_IServices.GetCustandSuppAddrDetailDL(Entity_Name, CompID, BrchID, Entity_Type);
