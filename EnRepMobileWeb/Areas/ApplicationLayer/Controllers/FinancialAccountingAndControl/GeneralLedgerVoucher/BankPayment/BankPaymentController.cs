...
namespace EnRepMobileWeb.Areas.ApplicationLayer.Controllers.FinancialAccountingAndControl.GeneralLedgerVoucher.BankPayment
{
    public class BankPaymentController : Controller
    {
        ...
        string DocumentMenuId = "105104115120";
        Logging.ErrorLog Errorlog = new Logging.ErrorLog();
        Common_IServices _Common_IServices;
        BankPayment_IService _BankPayment_IService;
        DataTable dt;
        List<VouList> _BankPaymentList;
        public BankPaymentController(Common_IServices _Common_IServices, BankPayment_IService _BankPayment_IService)
        {
            this._Common_IServices = _Common_IServices;
            this._BankPayment_IService = _BankPayment_IService;
        }
        // GET: ApplicationLayer/BankPayment
        public ActionResult BankPayment(BankPaymentList_Model _BankPaymentList_Model)
        {
            ...
            //BankPaymentList_Model _BankPaymentList_Model = new BankPaymentList_Model();
            GetStatusList(_BankPaymentList_Model);
            GetAutoCompleteBankDetail(_BankPaymentList_Model);
            ...
            _BankPaymentList_Model.curr_list = _currList;
            if (TempData["ListFilterData"] != null && TempData["ListFilterData"].ToString() != "")
            {
                var ListFilterData = TempData["ListFilterData"].ToString();
                var a = ListFilterData.Split(',');
                _BankPaymentList_Model.Src_Type = a[0].Trim();
                _BankPaymentList_Model.bank_id = a[1].Trim();
                _BankPaymentList_Model.VouFromDate = a[2].Trim();
                _BankPaymentList_Model.VouToDate = a[3].Trim();
                _BankPaymentList_Model.Status = a[4].Trim();
                _BankPaymentList_Model.Curr_nm = a[5].Trim();
                _BankPaymentList_Model.Instr_type = a[6].Trim();
                _BankPaymentList_Model.Reco_Status = a[7].Trim();
                if (_BankPaymentList_Model.Status == "0")
                {
                    _BankPaymentList_Model.Status = null;
                }
                _BankPaymentList_Model.ListFilterData = TempData["ListFilterData"].ToString();
                /* Commented by Suraj Maurya on 25-07-2025 due to change in list bind method */
                //SearchBankPaymentDetail(_BankPaymentList_Model, _BankPaymentList_Model.Src_Type, _BankPaymentList_Model.bank_id, _BankPaymentList_Model.VouFromDate, _BankPaymentList_Model.VouToDate, _BankPaymentList_Model.Status, CompID, Br_ID, _BankPaymentList_Model.Curr_nm, _BankPaymentList_Model.Instr_type, _BankPaymentList_Model.Reco_Status);
            }
            else
            {
                _BankPaymentList_Model.VoucherList = GetBankPaymentListAll(_BankPaymentList_Model);
            }
            if (_BankPaymentList_Model.VouFromDate != null)
            {
                _BankPaymentList_Model.FromDate = _BankPaymentList_Model.VouFromDate;
            }
            _BankPaymentList_Model.Title = title;
            _BankPaymentList_Model.Title = title;
            _BankPaymentList_Model.VouSearch = null;

            return View("~/Areas/ApplicationLayer/Views/FinancialAccountingAndControl/GeneralLedgerVoucher/BankPayment/BankPaymentList.cshtml", _BankPaymentList_Model);
        }
        ...
        public ActionResult AddBankPaymentDetail()
        {
            ...
            ////    return RedirectToAction("BankPayment", AddNewModel);
            ////}
            ////if (commCont.CheckFinancialYear(CompID, Br_ID) == "FB Close")
            ////{
            ...
            return RedirectToAction("BankPaymentDetail", "BankPayment", _urlModel);
        }
        public ActionResult BankPaymentDetail(UrlModel _urlModel)
        {
            try
            {
                BankPayment_Model _BankPayment_Model = new BankPayment_Model();
                if (Session["CompId"] != null)
                {
                ...
                var _BankPayment_Model1 = TempData["ModelData"] as BankPayment_Model;
                if (_BankPayment_Model1 != null)
                {
                    ViewBag.DocumentMenuId = DocumentMenuId;
                    ViewBag.AppLevel = _Common_IServices.GetApprovalLevel(Comp_ID, Br_ID, DocumentMenuId).Tables[0];
                    GetAutoCompleteGLDetail(_BankPayment_Model1);
                    ...
                    _BankPayment_Model1.currList = _currList;

                    /*---code Add by Hina sharma on 08-08-2024 for pdc  to chng Voucher Date-----*/
                    dt = GetGLVoucherDtForPDC();
                    _BankPayment_Model1.VouMin_Date = dt.Rows[0]["MinDate"].ToString();
                    _BankPayment_Model1.VouMax_Date = dt.Rows[0]["MaxDate"].ToString();
                    _BankPayment_Model1.ibt_acc = dt.Rows[0]["ibt_acc"].ToString();
                    /*---code End by Hina sharma on 09-08-2024 for pdc  to chng Voucher Date-----*/

                    if (TempData["ListFilterData"] != null && TempData["ListFilterData"].ToString() != "")
                    {
                        _BankPayment_Model1.ListFilterData1 = TempData["ListFilterData"].ToString();
                    }
                    // if (Session["TransType"].ToString() == "Update" || Session["TransType"].ToString() == "Edit")
                    if (_BankPayment_Model1.TransType == "Update" || _BankPayment_Model1.TransType == "Edit")
                    {
                        ...
                        //string VouNo = Session["BankPaymentNo"].ToString();
                        //string VouDt = Session["BankPaymentDate"].ToString();
                        string VouType = "BP";
                        string VouNo = _BankPayment_Model1.BankPaymentNo;
                        string VouDt = _BankPayment_Model1.BankPaymentDate;
                        DataSet ds = _BankPayment_IService.GetBankPaymentDetail(VouType, VouNo, VouDt, Comp_ID, Br_ID, UserID, DocumentMenuId);
                        _BankPayment_Model1.bank_acc_id = ds.Tables[0].Rows[0]["acc_id"].ToString();
                        _BankPayment_Model1.Vou_No = ds.Tables[0].Rows[0]["vou_no"].ToString();
                        _BankPayment_Model1.Vou_Date = Convert.ToDateTime(ds.Tables[0].Rows[0]["vou_dt"].ToString()).ToString("yyyy-MM-dd");
                        _BankPayment_Model1.Src_Type = ds.Tables[0].Rows[0]["src_doc"].ToString();
                        _BankPayment_Model1.src_doc_no = ds.Tables[0].Rows[0]["src_doc_no"].ToString();
                        _BankPayment_Model1.src_doc_date = ds.Tables[0].Rows[0]["src_doc_dt"].ToString();
                        _BankPayment_Model1.curr = Convert.ToInt32(ds.Tables[0].Rows[0]["curr_id"].ToString());
                        _BankPayment_Model1.bs_curr_id = Convert.ToInt32(ds.Tables[0].Rows[0]["bs_curr_id"].ToString());
                        _BankPayment_Model1.conv_rate = ds.Tables[0].Rows[0]["conv_rate"].ToString();
                        _BankPayment_Model1.hd_od_limit = Convert.ToDecimal(ds.Tables[0].Rows[0]["od_limit"]).ToString(ValDigit);
                        _BankPayment_Model1.hd_od_allow = ds.Tables[0].Rows[0]["od_allow"].ToString();
                        _BankPayment_Model1.RecoStatus = ds.Tables[0].Rows[0]["reco_status"].ToString();
                        _BankPayment_Model1.ReasonReturn = ds.Tables[0].Rows[0]["res_return"].ToString();/*Add By Hina on 29-08-2025 */
                        _BankPayment_Model1.HdnPDCFlag = ds.Tables[0].Rows[0]["pdc"].ToString();/*Add By Hina on 09-08-2024 for PDC and Interbranch*/
                        _BankPayment_Model1.HdnIntBrFlag = ds.Tables[0].Rows[0]["int_br"].ToString();
                        if (_BankPayment_Model1.HdnPDCFlag == "Y")/*Add by HIna on 09-08-2024*/
                        {
                            _BankPayment_Model1.PDCFlag = true;
                        }
                        else
                        {
                            _BankPayment_Model1.PDCFlag = false;
                        }
                        if (_BankPayment_Model1.HdnIntBrFlag == "Y")
                        {
                            _BankPayment_Model1.IntrBrnchFlag = true;
                        }
                        else
                        {
                            _BankPayment_Model1.IntrBrnchFlag = false;
                        }


                        //_BankPayment_Model1.Vou_amount = Convert.ToDecimal(ds.Tables[0].Rows[0]["vou_amt"]).ToString(ValDigit);

                        if (_BankPayment_Model1.RecoStatus.ToString() == "C ")
                        {
                            _BankPayment_Model1.RecoStatus = "Cleared";
                        }
                        else if (_BankPayment_Model1.RecoStatus.ToString() == "R ")
                        {
                            _BankPayment_Model1.RecoStatus = "Returned";
                        }
                        else if (_BankPayment_Model1.RecoStatus.ToString() == "U ")
                        {
                            _BankPayment_Model1.RecoStatus = "Un-Cleared";
                        }
                        else
                        {
                            _BankPayment_Model1.RecoStatus = "";
                        }


                        if (ds.Tables[7].Rows.Count > 0)
                        {
                            _BankPayment_Model1.Vou_amount = ds.Tables[7].Rows[0]["ClearBal"].ToString();
                        }
                        else
                        {
                            _BankPayment_Model1.Vou_amount = Convert.ToDecimal(0).ToString(RateDigit);
                        }


                        _BankPayment_Model1.Create_by = ds.Tables[0].Rows[0]["create_id"].ToString();
                        _BankPayment_Model1.Create_on = ds.Tables[0].Rows[0]["create_dt"].ToString();
                        _BankPayment_Model1.Approved_by = ds.Tables[0].Rows[0]["app_id"].ToString();
                        _BankPayment_Model1.Approved_on = ds.Tables[0].Rows[0]["app_dt"].ToString();
                        _BankPayment_Model1.Amended_by = ds.Tables[0].Rows[0]["mod_id"].ToString();
                        _BankPayment_Model1.Amended_on = ds.Tables[0].Rows[0]["mod_dt"].ToString();
                        _BankPayment_Model1.Create_id = ds.Tables[0].Rows[0]["creator_id"].ToString();
                        _BankPayment_Model1.VouStatus = ds.Tables[0].Rows[0]["app_status"].ToString();

                        _BankPayment_Model1.hd_od_allow = ds.Tables[0].Rows[0]["od_allow"].ToString();
                        _BankPayment_Model1.hd_od_limit = ds.Tables[0].Rows[0]["od_limit"].ToString();
                        ...
                        _BankPayment_Model1.ins_type = ds.Tables[0].Rows[0]["ins_type"].ToString();
                        _BankPayment_Model1.ins_no = ds.Tables[0].Rows[0]["ins_no"].ToString();
                        if (ds.Tables[0].Rows[0]["ins_dt"].ToString() != null && ds.Tables[0].Rows[0]["ins_dt"].ToString() != "")
                        {
                            _BankPayment_Model1.ins_dt = Convert.ToDateTime(ds.Tables[0].Rows[0]["ins_dt"].ToString()).ToString("yyyy-MM-dd");
                        }
                        _BankPayment_Model1.ins_name = ds.Tables[0].Rows[0]["ins_name"].ToString();
                        _BankPayment_Model1.BillAdjdetails = DataTableToJSONWithStringBuilder(ds.Tables[5]);
                        _BankPayment_Model1.Status = Statuscode;
                        //Session["DocumentStatus"] = Statuscode;
                        _BankPayment_Model1.DocumentStatus = Statuscode;
                        if (_BankPayment_Model1.Status == "C")
                        {
                            _BankPayment_Model1.CancelledRemarks = ds.Tables[0].Rows[0]["cancel_remarks"].ToString();
                            _BankPayment_Model1.CancelFlag = true;
                            //Session["BtnName"] = "Refresh";
                            _BankPayment_Model1.BtnName = "Refresh";
                        }
                        else
                        {
                            _BankPayment_Model1.CancelFlag = false;
                        }

                        _BankPayment_Model1.WFBarStatus = DataTableToJSONWithStringBuilder(ds.Tables[4]);
                        _BankPayment_Model1.WFStatus = DataTableToJSONWithStringBuilder(ds.Tables[3]);
                        ...
                        if (ViewBag.AppLevel != null && _BankPayment_Model1.Command != "Edit")
                        {
                            ...
                            if (Statuscode == "D")
                            {
                                ...
                                else
                                {
                                    if (nextLevel == "0")
                                    {
                                        ...
                                        _BankPayment_Model1.BtnName = "BtnToDetailPage";
                                    }
                                    else
                                    {
                                        ViewBag.Approve = "N";
                        ...
                        ViewBag.MenuPageName = getDocumentName();
                        _BankPayment_Model1.Title = title;
                        ViewBag.VouDetails = ds.Tables[1];
                        ViewBag.AttechmentDetails = ds.Tables[6];
                        ViewBag.CostCenterData = ds.Tables[8];
                        ViewBag.VBRoleList = GetRoleList();
                        ViewBag.DocumentStatus = _BankPayment_Model1.DocumentStatus;
                        ViewBag.TransType = _BankPayment_Model1.TransType;
                        ViewBag.Command = _BankPayment_Model1.Command;
                        ViewBag.MenuPageName = getDocumentName();
                        _BankPayment_Model1.Title = title;
                        return View("~/Areas/ApplicationLayer/Views/FinancialAccountingAndControl/GeneralLedgerVoucher/BankPayment/BankPaymentDetail.cshtml", _BankPayment_Model1);
                    }
                    else
                    {
                        ViewBag.TransType = _BankPayment_Model1.TransType;
                ...
                else
                {
                    ...
                    if (_urlModel != null)
                    {
                        if (_urlModel.bt == "D")
                        {
                            _BankPayment_Model.BtnName = "BtnToDetailPage";
                        }
                        else
                        {
                            _BankPayment_Model.BtnName = _urlModel.bt;
                        }
                        _BankPayment_Model.BankPaymentNo = _urlModel.VN;
                        _BankPayment_Model.BankPaymentDate = _urlModel.VDT;
                        _BankPayment_Model.Command = _urlModel.Cmd;
                        _BankPayment_Model.TransType = _urlModel.tp;
                        _BankPayment_Model.WF_Status1 = _urlModel.wf;
                    }
                    /* Add by Hina on 27-02-2024 to Refresh Page*/
                    if (_BankPayment_Model.TransType == null)
                    {
                        _BankPayment_Model.BtnName = "Refresh";
                        _BankPayment_Model.Command = "Refresh";
                        _BankPayment_Model.TransType = "Refresh";
                    ...
                    //    Br_ID = Session["BranchId"].ToString();
                    //var commCont = new CommonController(_Common_IServices);
                    ////var VouDate = _BankPayment_Model.BankPaymentDate;
                    //var VouDate = "";

                    //if (_BankPayment_Model.BankPaymentDate != null)
                    //{
                    //    VouDate = _BankPayment_Model.BankPaymentDate;
                    ...
                    //    DateTime dtnow = DateTime.Now;
                    //    string CurrentDate = new DateTime(dtnow.Year, dtnow.Month, dtnow.Day).ToString("yyyy-MM-dd");
                    //    _BankPayment_Model.BankPaymentDate = CurrentDate;
                    //    _BankPayment_Model.Vou_Date = CurrentDate;
                    //    VouDate = _BankPayment_Model.BankPaymentDate;
                    //}
                    ...
                    ViewBag.DocumentMenuId = DocumentMenuId;
                    ViewBag.AppLevel = _Common_IServices.GetApprovalLevel(Comp_ID, Br_ID, DocumentMenuId).Tables[0];
                    GetAutoCompleteGLDetail(_BankPayment_Model);
                    ...
                    /*---code Add by Hina sharma on 08-08-2024 for pdc  to chng Voucher Date-----*/
                    dt = GetGLVoucherDtForPDC();
                    _BankPayment_Model.VouMin_Date = dt.Rows[0]["MinDate"].ToString();
                    _BankPayment_Model.VouMax_Date = dt.Rows[0]["MaxDate"].ToString();
                    _BankPayment_Model.ibt_acc = dt.Rows[0]["ibt_acc"].ToString();
                    /*---code End by Hina sharma on 09-08-2024 for pdc  to chng Voucher Date-----*/

                    if (TempData["ListFilterData"] != null && TempData["ListFilterData"].ToString() != "")
                    {
                        _BankPayment_Model.ListFilterData1 = TempData["ListFilterData"].ToString();
                    }
                    // if (Session["TransType"].ToString() == "Update" || Session["TransType"].ToString() == "Edit")
                    if (_BankPayment_Model.TransType == "Update" || _BankPayment_Model.TransType == "Edit")
                    {
                        ...
                        //string VouDt = Session["BankPaymentDate"].ToString();
                        string VouType = "BR";
                        string VouNo = _BankPayment_Model.BankPaymentNo;
                        string VouDt = _BankPayment_Model.BankPaymentDate;
                        DataSet ds = _BankPayment_IService.GetBankPaymentDetail(VouType, VouNo, VouDt, Comp_ID, Br_ID, UserID, DocumentMenuId);
                        _BankPayment_Model.bank_acc_id = ds.Tables[0].Rows[0]["acc_id"].ToString();
                        _BankPayment_Model.Vou_No = ds.Tables[0].Rows[0]["vou_no"].ToString();
                        _BankPayment_Model.Vou_Date = Convert.ToDateTime(ds.Tables[0].Rows[0]["vou_dt"].ToString()).ToString("yyyy-MM-dd");
                        _BankPayment_Model.Src_Type = ds.Tables[0].Rows[0]["src_doc"].ToString();
                        _BankPayment_Model.src_doc_no = ds.Tables[0].Rows[0]["src_doc_no"].ToString();
                        _BankPayment_Model.src_doc_date = ds.Tables[0].Rows[0]["src_doc_dt"].ToString();
                        _BankPayment_Model.curr = Convert.ToInt32(ds.Tables[0].Rows[0]["curr_id"].ToString());
                        _BankPayment_Model.bs_curr_id = Convert.ToInt32(ds.Tables[0].Rows[0]["bs_curr_id"].ToString());
                        _BankPayment_Model.conv_rate = ds.Tables[0].Rows[0]["conv_rate"].ToString();
                        _BankPayment_Model.hd_od_limit = Convert.ToDecimal(ds.Tables[0].Rows[0]["od_limit"]).ToString(ValDigit);
                        _BankPayment_Model.hd_od_allow = ds.Tables[0].Rows[0]["od_allow"].ToString();
                        _BankPayment_Model.RecoStatus = ds.Tables[0].Rows[0]["reco_status"].ToString();
                        _BankPayment_Model.ReasonReturn = ds.Tables[0].Rows[0]["res_return"].ToString();/*Add By Hina on 29-08-2025 */
                        _BankPayment_Model.HdnPDCFlag = ds.Tables[0].Rows[0]["pdc"].ToString();/*Add By Hina on 09-08-2024 for PDC and Interbranch*/
                        _BankPayment_Model.HdnIntBrFlag = ds.Tables[0].Rows[0]["int_br"].ToString();
                        if (_BankPayment_Model.HdnPDCFlag == "Y")/*Add by HIna on 09-08-2024*/
                        {
                            _BankPayment_Model.PDCFlag = true;
                        }
                        else
                        {
                            _BankPayment_Model.PDCFlag = false;
                        }
                        if (_BankPayment_Model.HdnIntBrFlag == "Y")
                        {
                            _BankPayment_Model.IntrBrnchFlag = true;
                        }
                        else
                        {
                            _BankPayment_Model.IntrBrnchFlag = false;
                        }


                        if (_BankPayment_Model.RecoStatus.ToString() == "C ")
                        {
                            _BankPayment_Model.RecoStatus = "Cleared";
                        }
                        else if (_BankPayment_Model.RecoStatus.ToString() == "R ")
                        {
                            _BankPayment_Model.RecoStatus = "Returned";
                        }
                        else if (_BankPayment_Model.RecoStatus.ToString() == "U ")
                        {
                            _BankPayment_Model.RecoStatus = "Un-Cleared";
                        }
                        else
                        {
                            _BankPayment_Model.RecoStatus = "";
                        }
                        if (ds.Tables[7].Rows.Count > 0)
                        {
                            _BankPayment_Model.Vou_amount = ds.Tables[7].Rows[0]["ClearBal"].ToString();
                        }
                        else
                        {
                            _BankPayment_Model.Vou_amount = Convert.ToDecimal(0).ToString(RateDigit);
                        }


                        _BankPayment_Model.Create_by = ds.Tables[0].Rows[0]["create_id"].ToString();
                        _BankPayment_Model.Create_on = ds.Tables[0].Rows[0]["create_dt"].ToString();
                        _BankPayment_Model.Approved_by = ds.Tables[0].Rows[0]["app_id"].ToString();
                        _BankPayment_Model.Approved_on = ds.Tables[0].Rows[0]["app_dt"].ToString();
                        _BankPayment_Model.Amended_by = ds.Tables[0].Rows[0]["mod_id"].ToString();
                        _BankPayment_Model.Amended_on = ds.Tables[0].Rows[0]["mod_dt"].ToString();
                        _BankPayment_Model.Create_id = ds.Tables[0].Rows[0]["creator_id"].ToString();
                        _BankPayment_Model.VouStatus = ds.Tables[0].Rows[0]["app_status"].ToString();

                        _BankPayment_Model.hd_od_allow = ds.Tables[0].Rows[0]["od_allow"].ToString();
                        _BankPayment_Model.hd_od_limit = ds.Tables[0].Rows[0]["od_limit"].ToString();

                        string approval_id = ds.Tables[0].Rows[0]["approval_id"].ToString();
                        string Statuscode = ds.Tables[0].Rows[0]["status_code"].ToString();
                        string create_id = ds.Tables[0].Rows[0]["creator_id"].ToString();

                        _BankPayment_Model.ins_type = ds.Tables[0].Rows[0]["ins_type"].ToString();
                        _BankPayment_Model.ins_no = ds.Tables[0].Rows[0]["ins_no"].ToString();
                        if (ds.Tables[0].Rows[0]["ins_dt"].ToString() != null && ds.Tables[0].Rows[0]["ins_dt"].ToString() != "")
                        {
                            _BankPayment_Model.ins_dt = Convert.ToDateTime(ds.Tables[0].Rows[0]["ins_dt"].ToString()).ToString("yyyy-MM-dd");
                        }
                        _BankPayment_Model.ins_name = ds.Tables[0].Rows[0]["ins_name"].ToString();
                        _BankPayment_Model.BillAdjdetails = DataTableToJSONWithStringBuilder(ds.Tables[5]);
                        _BankPayment_Model.Status = Statuscode;
                        //Session["DocumentStatus"] = Statuscode;
                        _BankPayment_Model.DocumentStatus = Statuscode;
                        if (_BankPayment_Model.Status == "C")
                        {
                            _BankPayment_Model.CancelledRemarks = ds.Tables[0].Rows[0]["cancel_remarks"].ToString();
                            _BankPayment_Model.CancelFlag = true;
                            //Session["BtnName"] = "Refresh";
                            _BankPayment_Model.BtnName = "Refresh";
                        }
                        else
                        {
                            _BankPayment_Model.CancelFlag = false;
                        }

                        _BankPayment_Model.WFBarStatus = DataTableToJSONWithStringBuilder(ds.Tables[4]);
                        _BankPayment_Model.WFStatus = DataTableToJSONWithStringBuilder(ds.Tables[3]);
                        ...
                        //if (ViewBag.AppLevel != null && Session["Command"].ToString() != "Edit")
                        if (ViewBag.AppLevel != null && _BankPayment_Model.Command != "Edit")
                        {
                        ...
                        ViewBag.TotalVouAmt = ds.Tables[0].Rows[0]["vou_amt"];
                        ViewBag.MenuPageName = getDocumentName();
                        _BankPayment_Model.Title = title;
                        ViewBag.VouDetails = ds.Tables[1];
                        ViewBag.AttechmentDetails = ds.Tables[6];
                        ViewBag.CostCenterData = ds.Tables[8];
                        ViewBag.VBRoleList = GetRoleList();
                        ViewBag.TransType = _BankPayment_Model.TransType;
                        ViewBag.DocumentStatus = _BankPayment_Model.DocumentStatus;
                        ViewBag.Command = _BankPayment_Model.Command;
                        ViewBag.MenuPageName = getDocumentName();
                        _BankPayment_Model.Title = title;
                        return View("~/Areas/ApplicationLayer/Views/FinancialAccountingAndControl/GeneralLedgerVoucher/BankPayment/BankPaymentDetail.cshtml", _BankPayment_Model);
                    }
                    else
                    {
                        _BankPayment_Model.DocumentStatus = "D";
                        ViewBag.TransType = _BankPayment_Model.TransType;
                        ViewBag.DocumentStatus = _BankPayment_Model.DocumentStatus;
                        ViewBag.Command = _BankPayment_Model.Command;
                        ViewBag.VBRoleList = GetRoleList();
        ...
        {/*start Add by Hina on 27-02-2024 to chk Financial year exist or not*/
            ...
            //Session["BankPaymentNo"] = VouNo;
            //Session["BankPaymentDate"] = Voudt;
            ...
            dblclick.BankPaymentNo = VouNo;
            dblclick.BankPaymentDate = Voudt;
            ...
            return RedirectToAction("BankPaymentDetail", "BankPayment", _url);
        }
        public ActionResult GetBankPaymentList(string docid, string status)
        {

            //Session["WF_status"] = status;
            BankPaymentList_Model Dashbord = new BankPaymentList_Model();
            Dashbord.WF_Status = status;
            return RedirectToAction("BankPayment", Dashbord);
        }
        ...
        public ActionResult GetAutoCompleteGLDetail(BankPayment_Model _BankPayment_Model)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(_BankPayment_Model.BankName))
                {
                    Acc_Name = "0";
                }
                else
                {
                    Acc_Name = _BankPayment_Model.BankName;
                }
                if (Session["BranchId"] != null)
                {
                    Br_ID = Session["BranchId"].ToString();
                ...
                _BankPayment_Model.BankAccNameList = _BankAccNameList;
            }
            catch (Exception Ex)
            {
                string path = Server.MapPath("~");
        ...
        public ActionResult GetAutoCompleteBankDetail(BankPaymentList_Model _BankPaymentList_Model)
        {
            string Acc_Name = string.Empty;
            Dictionary<string, string> BankAccList = new Dictionary<string, string>();
            string Comp_ID = string.Empty;
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(_BankPaymentList_Model.bank_name))
                {
                    Acc_Name = "0";
                }
                else
                {
                    Acc_Name = _BankPaymentList_Model.bank_name;
                }
                Br_ID = Session["BranchId"].ToString();
                BankAccList = _BankPayment_IService.AutoGetBankAccList(Comp_ID, Acc_Name, Br_ID);
                ...
                _BankPaymentList_Model.BankAccNameList = _BankAccNameList;
            }
            catch (Exception Ex)
            {
                string path = Server.MapPath("~");
        ...
        [HttpPost]
        public ActionResult BankPaymentSave(BankPayment_Model _BankPayment_Model, string Vou_No, string command)
        {
            try
            {
                /*start Add by Hina on 27-02-2024 to chk Financial year exist or not*/
                ...
                /*End to chk Financial year exist or not*/
                if (_BankPayment_Model.DeleteCommand == "Delete")
                {
                    command = "Delete";
                }
                switch (command)
                {
                    case "AddNew":
                        ...
                        //    return RedirectToAction("BankPaymentDetail", "BankPayment", adddnew);
                        //}
                        //if (MsgNew == "FB Close")
                        //{
                        //    TempData["FBMessage"] = "Financial Book Closing";
                        ...
                        //}
                        ///*End to chk Financial year exist or not*/
                        return RedirectToAction("BankPaymentDetail", "BankPayment", NewModel);
                    ...
                    case "Edit":
                        ...
                        if (Session["BranchId"] != null)
                            Br_ID = Session["BranchId"].ToString();
                        string Voudt = _BankPayment_Model.Vou_Date;
                        Msg = commCont.Fin_CheckFinancialYear(CompID, Br_ID, Voudt);
                        if (Msg == "FY Not Exist" || Msg == "FB Close")
                        {
                            if (_BankPayment_Model.Status == "A" || _BankPayment_Model.Status == "D")
                            {
                                if (Msg == "FY Not Exist")
                                {
                                    TempData["Message"] = "Financial Year not Exist";
                                ...
                                return RedirectToAction("EditVou", new { VouNo = _BankPayment_Model.Vou_No, Voudt = _BankPayment_Model.Vou_Date, ListFilterData = _BankPayment_Model.ListFilterData1, WF_Status = _BankPayment_Model.WFStatus });
                            }
                        }
                        /*End to chk Financial year exist or not*/
                        /*Comment by Hina sharma on 31-07-2024 to for msg cz it will not cancel if autogenerated*/

                        //if (CheckAdvancePayment(_BankPayment_Model, _BankPayment_Model.Vou_No, _BankPayment_Model.Vou_Date) == "Used")
                        //{
                        //    //Session["Message"] = "Used";
                        //    _BankPayment_Model.Message = "Used";
                        //    TempData["ModelData"] = _BankPayment_Model;
                        //}
                        string FinalStatus = CheckAdvancePayment(_BankPayment_Model, _BankPayment_Model.Vou_No, _BankPayment_Model.Vou_Date);
                        if (FinalStatus == "Used" || FinalStatus == "Used1"
                            || FinalStatus == "BillPaidByCustomer" || FinalStatus == "AdvUsedByCustomer")
                        {
                            //Session["Message"] = FinalStatus;
                            _BankPayment_Model.Message = FinalStatus;
                            _BankPayment_Model.Message1 = FinalStatus;
                            _BankPayment_Model.Command = "Refresh";
                            TempData["ModelData"] = _BankPayment_Model;
                        }
                        else
                        {
                            ...
                            //Session["Message"] = "New";
                            //Session["AppStatus"] = 'D';
                            //Session["BankPaymentNo"] = _BankPayment_Model.Vou_No;
                            //Session["BankPaymentDate"] = _BankPayment_Model.Vou_Date.ToString();
                            _BankPayment_Model.TransType = "Update";
                            _BankPayment_Model.Command = command;
                            _BankPayment_Model.BtnName = "BtnEdit";
                            _BankPayment_Model.BankPaymentNo = _BankPayment_Model.Vou_No;
                            _BankPayment_Model.BankPaymentDate = _BankPayment_Model.Vou_Date;
                            TempData["ModelData"] = _BankPayment_Model;
                            UrlModel EditModel = new UrlModel();
                            EditModel.tp = "Update";
                            EditModel.Cmd = command;
                            EditModel.bt = "BtnEdit";
                            EditModel.VN = _BankPayment_Model.BankPaymentNo;
                            EditModel.VDT = _BankPayment_Model.BankPaymentDate;
                            TempData["ListFilterData"] = _BankPayment_Model.ListFilterData1;
                            return RedirectToAction("BankPaymentDetail", EditModel);
                        }
                        UrlModel Edit_Model = new UrlModel();
                        Edit_Model.tp = "Update";
                        Edit_Model.bt = "D";
                        Edit_Model.VN = _BankPayment_Model.BankPaymentNo;
                        Edit_Model.VDT = _BankPayment_Model.BankPaymentDate;
                        TempData["ListFilterData"] = _BankPayment_Model.ListFilterData1;
                        return RedirectToAction("BankPaymentDetail", Edit_Model);

                    case "Delete":
                        //Session["Command"] = command;
                        //Session["BtnName"] = "Refresh";
                        Vou_No = _BankPayment_Model.Vou_No;
                        _BankPayment_Model.Command = command;
                        BankPaymentDelete(_BankPayment_Model, command);
                        ...
                        Delete.bt = "BtnDelete";
                        TempData["ListFilterData"] = _BankPayment_Model.ListFilterData1;
                        return RedirectToAction("BankPaymentDetail", Delete);
                    ...
                    case "Save":
                        ...
                        if (Session["BranchId"] != null)
                            Br_ID = Session["BranchId"].ToString();
                        string Voudt1 = _BankPayment_Model.Vou_Date;
                        ...
                        if (Msg == "FY Not Exist" || Msg == "FB Close")
                        {
                            ...
                            if (_BankPayment_Model.Vou_No == null)
                            {
                                _BankPayment_Model.Command = "Refresh";
                                _BankPayment_Model.TransType = "Refresh";
                                _BankPayment_Model.BtnName = "Refresh";
                                _BankPayment_Model.DocumentStatus = null;
                                TempData["ModelData"] = _BankPayment_Model;
                                return RedirectToAction("BankPaymentDetail", "BankPayment", _BankPayment_Model);
                            }
                            else
                            {
                                return RedirectToAction("EditVou", new { VouNo = _BankPayment_Model.Vou_No, Voudt = _BankPayment_Model.Vou_Date, ListFilterData = _BankPayment_Model.ListFilterData1, WF_Status = _BankPayment_Model.WFStatus });
                        ...
                        // Session["Command"] = command;
                        _BankPayment_Model.Command = command;
                        SaveBankPayment(_BankPayment_Model);
                        if (_BankPayment_Model.Message == "DataNotFound")
                        {
                            return View("~/Views/Shared/Error.cshtml");
                        }
                        else if (_BankPayment_Model.Message == "N")
                        {
                            List<curr> _currList = new List<curr>();
                            dt = Getcurr();
                            foreach (DataRow dr in dt.Rows)
                            ...
                            var other = new CommonController(_Common_IServices);
                            ViewBag.AppLevel = other.GetApprovalLevel(CompID, Br_ID, DocumentMenuId);
                            _BankPayment_Model.BtnName = "BtnAddNew";
                            _BankPayment_Model.Command = "Add";
                            _BankPayment_Model.Message = "N";
                            ViewBag.DocumentMenuId = DocumentMenuId;
                            ViewBag.VBRoleList = GetRoleList();
                            return View("~/Areas/ApplicationLayer/Views/FinancialAccountingAndControl/GeneralLedgerVoucher/BankPayment/BankPaymentDetail.cshtml", _BankPayment_Model);
                        }
                        else
                        {
                            TempData["ModelData"] = _BankPayment_Model;
                            UrlModel _urlModel = new UrlModel();
                            _urlModel.bt = _BankPayment_Model.BtnName;
                            _urlModel.Cmd = _BankPayment_Model.Command;
                            _urlModel.VN = _BankPayment_Model.BankPaymentNo;
                            _urlModel.VDT = _BankPayment_Model.BankPaymentDate;
                            _urlModel.tp = _BankPayment_Model.TransType;
                            //Session["BankPaymentNo"] = Session["BankPaymentNo"].ToString();
                            //Session["BankPaymentDate"] = Session["BankPaymentDate"].ToString();
                            TempData["ListFilterData"] = _BankPayment_Model.ListFilterData1;
                            return RedirectToAction("BankPaymentDetail", _urlModel);
                        }
                    ...
                    case "Approve":
                        ...
                        if (Session["BranchId"] != null)
                            Br_ID = Session["BranchId"].ToString();
                        string Voudt3 = _BankPayment_Model.Vou_Date;
                        ...
                        _BankPayment_Model.Command = command;
                        Vou_No = _BankPayment_Model.Vou_No;
                        //Session["BankPaymentNo"] = Vou_No;
                        //Session["BankPaymentDate"] = _BankPayment_Model.Vou_Date;
                        BankPaymentApprove(_BankPayment_Model, _BankPayment_Model.Vou_No, _BankPayment_Model.Vou_Date, "", "", "", "", "", _BankPayment_Model.HdnIntBrNurr_BP);
                        TempData["ModelData"] = _BankPayment_Model;
                        UrlModel urlref = new UrlModel();
                        urlref.tp = "Update";
                        urlref.VN = _BankPayment_Model.BankPaymentNo;
                        urlref.VDT = _BankPayment_Model.BankPaymentDate;
                        urlref.bt = "BtnEdit";
                        if (_BankPayment_Model.WF_Status1 != null)
                        {
                            urlref.wf = _BankPayment_Model.WF_Status1;
                        }
                        TempData["ListFilterData"] = _BankPayment_Model.ListFilterData1;
                        return RedirectToAction("BankPaymentDetail", urlref);
                    ...
                    case "Refresh":
                        ...
                        refesh.Cmd = command;
                        TempData["ListFilterData"] = _BankPayment_Model.ListFilterData1;
                        return RedirectToAction("BankPaymentDetail", refesh);

                    case "Print":
                        return GenratePdfFile(_BankPayment_Model);
                    case "BacktoList":
                        ...
                        _BankReceiptList_Model.WF_Status = _BankPayment_Model.WF_Status1;
                        TempData["ListFilterData"] = _BankPayment_Model.ListFilterData1;
                        return RedirectToAction("BankPayment", "BankPayment", _BankReceiptList_Model);
        ...
        public ActionResult SaveBankPayment(BankPayment_Model _BankPayment_Model)
        {
            string SaveMessage = "";
            ...
            try
            {
                ...
                string InterBrch = "N";
                if (_BankPayment_Model.CancelFlag == false)
                {
                    if (Session["compid"] != null)
                    {
                        CompID = Session["compid"].ToString();
                    ...
                    Br_ID = Session["BranchId"].ToString();
                    if (_BankPayment_Model.HdnPDCFlag == null)/*Add By Hina on 09-08-2024 for PDC and Interbranch*/
                    {
                        PDC = "N";
                    }
                    else
                    {
                        PDC = _BankPayment_Model.HdnPDCFlag;
                    }
                    if (_BankPayment_Model.HdnIntBrFlag == null)
                    {
                        InterBrch = "N";
                    }
                    else
                    {
                        InterBrch = _BankPayment_Model.HdnIntBrFlag;
                    }
                    DataTable BankPaymentHeader = new DataTable();
                    DataTable BankPaymentGLDetails = new DataTable();
                    DataTable BankPaymentBillAdjDetail = new DataTable();
                    ...
                    dtrowHeader["vou_type"] = "BP";
                    dtrowHeader["vou_no"] = _BankPayment_Model.Vou_No;
                    dtrowHeader["vou_dt"] = _BankPayment_Model.Vou_Date;
                    dtrowHeader["src_doc"] = _BankPayment_Model.Src_Type;
                    dtrowHeader["src_doc_no"] = null;
                    dtrowHeader["src_doc_dt"] = null;
                    dtrowHeader["vou_amt"] = "0";
                    dtrowHeader["remarks"] = _BankPayment_Model.Remarks;
                    ...
                    dtrowHeader["ins_type"] = _BankPayment_Model.ins_type;
                    dtrowHeader["ins_no"] = _BankPayment_Model.ins_no;
                    dtrowHeader["ins_dt"] = _BankPayment_Model.ins_dt;
                    dtrowHeader["ins_name"] = _BankPayment_Model.ins_name;


                    dtheader.Rows.Add(dtrowHeader);
                    BankPaymentHeader = dtheader;
                    ...
                    dtAccount.Columns.Add("int_br_id", typeof(string));

                    JArray jObject = JArray.Parse(_BankPayment_Model.GlAccountDetails);
                    ...
                    for (int i = 0; i < jObject.Count; i++)
                    {
                        ...
                        dtrowLines["int_br_id"] = jObject[i]["GlBrID"].ToString() == "0" ? Br_ID : jObject[i]["GlBrID"].ToString();//jObject[i]["GlBrID"].ToString();
                        dtAccount.Rows.Add(dtrowLines);
                    }
                    BankPaymentGLDetails = dtAccount;
                    ...
                    dtBillAdjDetail.Columns.Add("int_br_id", typeof(string));
                    JArray BObject = JArray.Parse(_BankPayment_Model.BillAdjdetails);
                    for (int i = 0; i < BObject.Count; i++)
                    {
                        ...
                        dtrowLines["int_br_id"] = BObject[i]["GlBrID"].ToString() == "0" ? Br_ID : BObject[i]["GlBrID"].ToString();
                        dtBillAdjDetail.Rows.Add(dtrowLines);
                    }
                    BankPaymentBillAdjDetail = dtBillAdjDetail;
                    ...
                    CC_Details.Columns.Add("int_br_id", typeof(string));



                    JArray JAObj = JArray.Parse(_BankPayment_Model.CC_DetailList);
                    for (int i = 0; i < JAObj.Count; i++)
                    {
                        ...
                        dtrowLines["int_br_id"] = JAObj[i]["int_br_id"].ToString() == "0" ? Br_ID : JAObj[i]["int_br_id"].ToString();
                    ...
                    DataTable BPAttachments = new DataTable();
                    DataTable BPdtAttachment = new DataTable();
                    var attachData = TempData["IMGDATA"] as BankPaymentModel;
                    TempData["IMGDATA"] = null;
                    if (_BankPayment_Model.attatchmentdetail != null)
                    {

                        //if (Session["AttachMentDetailItmStp"] != null)
                        //{
                        //    BPdtAttachment = Session["AttachMentDetailItmStp"] as DataTable;
                        //}
                        if (attachData != null)
                        {
                            if (attachData.AttachMentDetailItmStp != null)
                            {
                                BPdtAttachment = attachData.AttachMentDetailItmStp as DataTable;
                            }
                            else
                            {
                        ...
                        {
                            if (_BankPayment_Model.AttachMentDetailItmStp != null)
                            {
                                BPdtAttachment = _BankPayment_Model.AttachMentDetailItmStp as DataTable;
                            }
                            else
                            {
                                BPdtAttachment.Columns.Add("id", typeof(string));
                        ...
                        JArray jObject1 = JArray.Parse(_BankPayment_Model.attatchmentdetail);
                        for (int i = 0; i < jObject1.Count; i++)
                        {
                            ...
                            if (flag == "Y")
                            {
                                ...
                                if (!string.IsNullOrEmpty((_BankPayment_Model.Vou_No).ToString()))
                                {
                                    dtrowAttachment1["id"] = _BankPayment_Model.Vou_No;
                                }
                                else
                                {
                        ...
                        if (_BankPayment_Model.TransType == "Update")
                        {
                            ...
                            if (Directory.Exists(AttachmentFilePath))
                            {
                                ...
                                if (!string.IsNullOrEmpty((_BankPayment_Model.Vou_No).ToString()))
                                {
                                    BP_CODE = (_BankPayment_Model.Vou_No).ToString();
                                }
                                else
                                {
                                    BP_CODE = "0";
                        ...
                        BPAttachments = BPdtAttachment;
                    }
                    /*-----------------Attachment Section End------------------------*/



                    SaveMessage = _BankPayment_IService.InsertBankPaymentDetail(BankPaymentHeader, BankPaymentGLDetails
                        , BankPaymentBillAdjDetail, BPAttachments, CRCostCenterDetails, PDC, InterBrch);
                    if (SaveMessage == "FY Not Exist")/*Add by Hina on on 25-03-2025 for check financial year exits or not along with book opening*/
                    {
                        ...
                        _BankPayment_Model.TransType = "Refresh";
                        //TempData["ModelData"] = _BankPayment_Model;
                        return RedirectToAction("BankPaymentDetail");
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (Message == "Data_Not_Found")
                            {
                                ...
                                var msg = Message.Replace("_", " ") + " " + BankPaymentNo + " in " + PageName;//BankReceiptNo is use for table type
                                string path = Server.MapPath("~");
                                Errorlog.LogError_customsg(path, msg, "", "");
                                _BankPayment_Model.Message = Message.Split(',')[0].Replace("_", "");
                                return RedirectToAction("BankPaymentDetail");
                            }
                            /*-----------------Attachment Section Start------------------------*/
                            if (Message == "Save")

                            {
                                ...
                                comCont.ResetImageLocation(CompID, Br_ID, guid, PageName, BP_Number, _BankPayment_Model.TransType, BPAttachments);
                                ...
                                //        foreach (DataRow dr in BPAttachments.Rows)
                                //        {
                                //            string DrItmNm = dr["file_name"].ToString();
                                //            if (ItemName == DrItmNm)
                                //            {
                                //                string img_nm = CompID + Br_ID + BP_Number + "_" + Path.GetFileName(DrItmNm).ToString();
                            ...
                            if (Message == "Update" || Message == "Save")
                                ...
                                //Session["Command"] = "Update";
                                //Session["BankPaymentNo"] = BankPaymentNo;
                                //Session["BankPaymentDate"] = BankPaymentDate;
                                //Session["TransType"] = "Update";
                                //Session["AppStatus"] = 'D';
                                //Session["BtnName"] = "BtnToDetailPage";
                                _BankPayment_Model.Message = "Save";
                            _BankPayment_Model.Command = "Update";
                            _BankPayment_Model.BankPaymentNo = BankPaymentNo;
                            _BankPayment_Model.BankPaymentDate = BankPaymentDate;
                            _BankPayment_Model.TransType = "Update";
                            _BankPayment_Model.BtnName = "BtnToDetailPage";
                            return RedirectToAction("BankPaymentDetail");
                        }
                ...
                else
                {
                    ...
                    {
                        _BankPayment_Model.Create_by = UserID;
                        string br_id = Session["BranchId"].ToString();
                        string mac = Session["UserMacaddress"].ToString();
                        string system = Session["UserSystemName"].ToString();
                        string ip = Session["UserIP"].ToString();
                        string mac_id = "MAC:" + mac + ",SystemName:" + system + ",IP:" + ip;
                        DataSet SaveMessage1 = _BankPayment_IService.BankPaymentCancel(_BankPayment_Model, CompID, br_id, mac_id);

                        try
                        {
                            //string fileName = "BP_" + DateTime.Now.ToString("ddMMyyyyhhmmss") + ".pdf";
                            string fileName = "BankPayment_" + System.DateTime.Now.ToString("ddMMyyyyhhmmss") + ".pdf"; 
                            var filePath = SavePdfDocToSendOnEmailAlert(_BankPayment_Model.Vou_No, _BankPayment_Model.Vou_Date, fileName, DocumentMenuId,"C");
                            _Common_IServices.SendAlertEmail(CompID, br_id, DocumentMenuId, _BankPayment_Model.Vou_No, "C", UserID, "", filePath);
                        }
                        catch (Exception exMail)
                        {
                            _BankPayment_Model.Message = "ErrorInMail";
                            string path = Server.MapPath("~");
                            Errorlog.LogError(path, exMail);
                        }
                        _BankPayment_Model.Message = _BankPayment_Model.Message == "ErrorInMail" ? "Cancelled_ErrorInMail" : "Cancelled";
                        // _BankPayment_Model.Message = "Cancelled";
                        _BankPayment_Model.Command = "Update";
                        _BankPayment_Model.BankPaymentNo = _BankPayment_Model.Vou_No;
                        _BankPayment_Model.BankPaymentDate = _BankPayment_Model.Vou_Date;
                        _BankPayment_Model.TransType = "Update";
            ...
            catch (Exception ex)
            {
                ...
                {
                    if (_BankPayment_Model.TransType == "Save")
                    {
                        string Guid = "";
                        if (_BankPayment_Model.Guid != null)
                        {
                            //Guid = Session["Guid"].ToString();
                            Guid = _BankPayment_Model.Guid;
                        }
                        var other = new CommonController(_Common_IServices);
        ...
        private object IsNull(string inValue, object outValue)
        {
            return string.IsNullOrEmpty(inValue) ? outValue : inValue;
        }
        private string IsNull1(string inValue, string outValue)
        {
            return string.IsNullOrEmpty(inValue) ? outValue : inValue;
        }
        ...
        public void GetStatusList(BankPaymentList_Model _BankPaymentList_Model)
        {
            try
            {
                ...
                _BankPaymentList_Model.StatusList = listOfStatus;
            }
            catch (Exception Ex)
            {
                string path = Server.MapPath("~");
        ...
        private List<VouList> GetBankPaymentListAll(BankPaymentList_Model _BankPaymentList_Model)
        {
            try
            {
                _BankPaymentList = new List<VouList>();
                if (Session["CompId"] != null)
                {
                    CompID = Session["CompId"].ToString();
                }
                ...
                //}
                if (_BankPaymentList_Model.WF_Status != null)
                {
                    wfstatus = _BankPaymentList_Model.WF_Status;
                }
                else
                {
                    wfstatus = "";
                ...
                Dtdata = _BankPayment_IService.GetBankPaymentListAll(_BankPaymentList_Model.Src_Type, _BankPaymentList_Model.bank_id
                    , _BankPaymentList_Model.VouFromDate, _BankPaymentList_Model.VouToDate, _BankPaymentList_Model.Status, CompID, Br_ID, VouType
                    , wfstatus, UserID, DocumentMenuId, "", "", "","0","25","","SrNo","ASC","OnlyDateRange");
                if (Dtdata.Tables[0].Rows.Count > 0)
                {
                    _BankPaymentList_Model.FromDate = Dtdata.Tables[0].Rows[0]["finstrdate"].ToString();
                    _BankPaymentList_Model.FinalToDate = Dtdata.Tables[0].Rows[0]["finenddate"].ToString();/*add By hina on 09-08-2024 for show all transaction in future date also*/
                }
                //if (Dtdata.Tables[0].Rows.Count > 0)//Commented by Suraj Maurya on 25-07-2025 due to list bind method is changed
                //{
                ...
                //        _BankPaymentList.Add(_VouList);
                //    }
                //}
                return _BankPaymentList;
            }
            catch (Exception Ex)
            {
                string path = Server.MapPath("~");
        ...
        [HttpPost]
        public ActionResult SearchBankPaymentDetail(BankPaymentList_Model _BankPaymentList_Model, string Src_Type, string bank_id, string Fromdate, string Todate, string Status, string CompID, string Br_ID, string Currency, string InsType, string RecoStatus)
        {
            _BankPaymentList = new List<VouList>();
            //BankPaymentList_Model _BankPaymentList_Model = new BankPaymentList_Model();
            //Session["WF_status"] = "";
            _BankPaymentList_Model.WF_Status = null;
            //if (Session["CompId"] != null)
            //{
            //    CompID = Session["CompId"].ToString();
            //}
            ...
            //_BankPaymentList_Model.VouSearch = "Vou_Search";
            ...
            //    }
            //}
            _BankPaymentList_Model.VoucherList = _BankPaymentList;
            return PartialView("~/Areas/ApplicationLayer/Views/Shared/PartialBankPaymentList.cshtml", _BankPaymentList_Model);
        }

        private ActionResult BankPaymentDelete(BankPayment_Model _BankPayment_Model, string command)
        {
            try
            {
                ...
                string BPNo = _BankPayment_Model.Vou_No;
                string BankPayNumber = BPNo.Replace("/", "");

                string Message = _BankPayment_IService.BPDelete(_BankPayment_Model, CompID, br_id, DocumentMenuId);
                ...
                //Session["BankPaymentNo"] = "";
                //Session["BankPaymentDate"] = "";
                //_BankPayment_Model = null;
        ...
        public ActionResult BankPaymentApprove(BankPayment_Model _BankPayment_Model, string VouNo, string VouDate, string A_Status, string A_Level, string A_Remarks, string ListFilterData1, string WF_Status1, string int_br_nurr)
        {
            try
            {
                ...
                string ip = Session["UserIP"].ToString();
                string mac_id = "MAC:" + mac + ",SystemName:" + system + ",IP:" + ip;
                string Message = _BankPayment_IService.BankPaymentApprove(VouNo, VouDate, UserID, A_Status, A_Level, A_Remarks
                    , Comp_ID, BranchID, mac_id, DocumentMenuId, int_br_nurr);
                // Session["TransType"] = "Update";
                //Session["Command"] = command;
                string BankPaymentNo = Message.Split(',')[0].Trim();
                string BankPaymentDate = Message.Split(',')[1].Trim();
                string result = Message.Split(',')[2].Trim();
                //Session["BankPaymentNo"] = BankPaymentNo;
                //Session["BankPaymentDate"] = BankPaymentDate;
                ...
                _BankPayment_Model.BankPaymentNo = BankPaymentNo;
                _BankPayment_Model.BankPaymentDate = BankPaymentDate;
                _BankPayment_Model.Message = result;//"Approved";
                _BankPayment_Model.BtnName = "BtnEdit";
                try
                {
                    string fileName = "BankPayment_" + System.DateTime.Now.ToString("ddMMyyyyhhmmss") + ".pdf";
                ...
                _BankPayment_Model.Message = _BankPayment_Model.Message == "ErrorInMail" ? "Approved_ErrorInMail" : "Approved";
                if (WF_Status1 != null && WF_Status1 != "")
                {
                    _BankPayment_Model.WF_Status1 = WF_Status1;
                    urlapp_model.wf = WF_Status1;
                }
                TempData["ModelData"] = _BankPayment_Model;
                urlapp_model.tp = "Update";
                urlapp_model.VN = BankPaymentNo;
                urlapp_model.VDT = BankPaymentDate;
                urlapp_model.bt = "BtnEdit";
                TempData["ListFilterData"] = ListFilterData1;
                return RedirectToAction("BankPaymentDetail", "BankPayment", urlapp_model);
            }
            catch (Exception ex)
            {
                string path = Server.MapPath("~");
        ...
        public ActionResult ToRefreshByJS(string ListFilterData1, string ModelData,string Mailerror)
        {
            ...
            _BankPayment_Model.BankPaymentNo = a[0].Trim();
            _BankPayment_Model.BankPaymentDate = a[1].Trim();
            _BankPayment_Model.TransType = "Update";
            _BankPayment_Model.BtnName = "BtnToDetailPage";
            _BankPayment_Model.Message =  Mailerror;
            if (a[2].Trim() != null && a[2].Trim() != "")
            {
                _BankPayment_Model.WF_Status1 = a[2].Trim();
                urlModel.wf = a[2].Trim();
            }
            urlModel.bt = "D";
            urlModel.VN = _BankPayment_Model.BankPaymentNo;
            urlModel.VDT = _BankPayment_Model.BankPaymentDate;
            urlModel.Cmd = "Update";
            urlModel.tp = "Update";
            TempData["ModelData"] = _BankPayment_Model;
            TempData["ListFilterData"] = ListFilterData1;
            return RedirectToAction("BankPaymentDetail", urlModel);
        }

        public ActionResult GetBillDetail(string AccId, string fromdt, string todt, string flag, string DocumentNumber
        ...
        public JsonResult Upload(string title, string DocNo, string TransType)
        {
            ...
            try
            {
                ...
                //}
                //if (Session["BankPaymentNo"] != null)
                //{
                //    BPayCode = Session["BankPaymentNo"].ToString();
                //}
                if (TransType == "Save")
                {
                    DocNo = gid.ToString();
        ...
        public string CheckAdvancePayment(BankPayment_Model _BankPayment_Model, string DocNo, string DocDate)
        {
            string str = "";
            try
            {
                ...
                {
                    str = "AdvUsedByCustomer";
                }
                if (str != "" && str != null)
                {
                    _BankPayment_Model.BankPaymentNo = DocNo;
                    _BankPayment_Model.BankPaymentDate = DocDate;
                    _BankPayment_Model.TransType = "Update";
                    _BankPayment_Model.BtnName = "BtnToDetailPage";
                }
            }
        ...
        {
            return File(GetPdfData(_Model.Vou_No, _Model.Vou_Date), "application/pdf", "BankPayment.pdf");
        }
        public byte[] GetPdfData(string voucherNo, string voucherDate)
        {
            ...
            try
            {
                ...
                DataSet Deatils = _Common_IServices.Cmn_GetGLVoucherPrintDeatils(CompID, Br_ID, voucherNo, voucherDate, "BP");
                ViewBag.PageName = "BP";
                if (Deatils.Tables[0].Rows[0]["int_br"].ToString().Trim() == "Y")
                {
                    //ViewBag.Title = "Bank Payment (Inter Branch)";/*Commented and change by Hina on 17-10-2024*/
                    ViewBag.Title = "Payment Voucher (Inter Branch)";
                }
                else
                {
                    /* ViewBag.Title = "Bank Payment";*//*Commented and change by Hina on 17-10-2024*/
                ...
                string FLogoPath = Deatils.Tables[0].Rows[0]["logo"].ToString().Trim();
                ...
                localDigiSignPath = "";//common.Cmn_GenLocalFilePath("", "", Server);// Downloading file localy and getting local path
                Cmn_pdfGenerate_model cmn_model = new Cmn_pdfGenerate_model() //Mendatory Code with Cmn_GenLocalFilePath
                {
                    ...
                    localDigiSignPath = localDigiSignPath
                };

                ViewBag.FLogoPath = localLogoPath;
                ViewBag.DigiSign = localDigiSignPath;

                string GLVoucherHtml = common.Cmn_ConvertPartialViewToString(PartialView("~/Areas/Common/Views/Cmn_GLVoucher_Print.cshtml"), ControllerContext);
                byte[] pdfData = common.Cmn_PdfFileGenerate(GLVoucherHtml, DocumentMenuId, ViewBag.DocStatus, Server, cmn_model);
        ...
        public ActionResult Get_rcptpaymhist(string Flag, string Accid)
        {
            try
            {
                if (Session["CompId"] != null)
                ...
                DataSet ds = _Common_IServices.Get_rcptpatmhist_details(CompID, Br_ID, Accid, Flag);

                if (ds.Tables.Count > 0)
                {
                    ViewBag.chqDetails = ds.Tables[0];
                }

                return PartialView("~/Areas/Common/Views/Cmn_PartialChequeDetail.cshtml");
            }
            catch (Exception ex)
            {
                string path = Server.MapPath("~");
        ...
        public JsonResult GetBranchList()
        {
            try
            {
                ...
                //    Br_ID = Session["BranchId"].ToString();
                //}
                DataTable ds = _BankPayment_IService.GetBranchList(CompID);
        ...
        //public FileResult BankPaymentExporttoExcelDt(string SrcType, string BankName, string Fromdate, string Todate, string Status, string Currency, string InsType, string RecoStatus)
        //{
        //    try
        //    {
        //        if (Session["CompId"] != null)
        ...
        //        return commonController.ExportDatatableToExcel("BankPayment", dt);
        //    }
        //    catch (Exception ex)
        //    {
        //        string path = Server.MapPath("~");
        ...
        public JsonResult LoadBankPaymentDetailsData(string Src_Type, string bank_id, string Fromdate, string Todate, string Status
            ...
            , string sortColumn, string sortColumnDir,string WF_Status,string Flag="")
        {
            ...
            try
            {
                ...
                DSet = _BankPayment_IService.GetBankPaymentListAll(Src_Type, bank_id, Fromdate, Todate, Status, CompID
                    , BrId, "BP", WF_Status, User_ID, "105104115120", Currency, InsType, RecoStatus
                    //, BrId, "BP", WF_Status, "", "", Currency, InsType, RecoStatus
        ...
        public ActionResult BankPaymentListActionCommands(BankPaymentList_Model _Model, string Command)
        {
            try
            {
        ...
        public FileResult GenrateCsvFile(BankPaymentList_Model _Model)
        {
            try
            {
                ...
                var SearchValue = IsNull1(_Model.searchValue, "");
                var Direction = IsNull1(_Model.sortColumnDir, "asc");
                var sortColumnNm = IsNull1(_Model.sortColumn, "SrNo");
                DataSet DSet = new DataSet();
                DSet = _BankPayment_IService.GetBankPaymentListAll(_Model.Src_Type, _Model.bank_id, _Model.FromDate
                    ...
                    , BrId, "BP", "", "", "", _Model.Curr_nm, _Model.Instr_type, _Model.Reco_Status
                     , "0", "50", SearchValue, sortColumnNm, Direction, "CSV");
                ...
                var commonController = new CommonController(_Common_IServices);
                return commonController.ExportDatatableToExcel("Bank Payment", newTable);
            }
            catch (Exception ex)
            {
                string path = Server.MapPath("~");
